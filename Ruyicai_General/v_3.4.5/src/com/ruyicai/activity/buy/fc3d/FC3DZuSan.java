...
public class FC3DZuSan extends ZixuanActivity implements OnCheckedChangeListener{
	...
	public AreaNum[] initArea() {
		...
		case PublicConst.BUY_FC3D_ZU3_DAN:
			...
			areaNums[0] = new AreaNum(10,10,1, 1, ballResId, 0, 0, Color.RED, baiTitle,false,true);
			areaNums[1] = new AreaNum(10,10,1, 1, ballResId, 0, 0, Color.RED, shiTitle,false,true);
	        return areaNums;

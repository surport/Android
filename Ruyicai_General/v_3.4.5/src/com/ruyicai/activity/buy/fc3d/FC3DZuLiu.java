...
public class FC3DZuLiu extends ZixuanActivity implements OnCheckedChangeListener{
	...
	public AreaNum[] initArea() {
		...
		case PublicConst.BUY_FC3D_HEZHI_ZU6:
			...
			areaNums[0] = new AreaNum(22,8,1, 1, ballResId, 0, 3,Color.RED,title,false,true);
	        return areaNums;
		case PublicConst.BUY_FC3D_ZU6:
			areaNums = new AreaNum[1];
			String title2 = getResources().getString(R.string.fc3d_text_hezhi_title).toString();
			areaNums[0] = new AreaNum(10,10,3, 9, ballResId, 0, 0, Color.RED, title2,false,true);
	        return areaNums;
		}
		return areaNums;
	}
...
//					alert(  "注码：" + fushiStr );
	...
	public void isBallTable(int iBallId){
		...
		case PublicConst.BUY_FC3D_ZU6:
			...
			itemViewArray.get(1).areaNums[0].table.changeBallState(itemViewArray.get(0).areaNums[0].chosenBallSum, iBallId);
			break;

...
public class Dlc extends ZixuanAndJiXuan {
	protected String type[] = {"R2","R3","R4","R5","R6","R7","R8","R1","Q2","Q3","Z2","Z3"};//类型
	...
	public AreaNum[] initArea() {
		...
		if(state.equals("Q2")){
			...
			areaNums[0] = new AreaNum(11,10,1, 11, BallResId, 0, 1,Color.RED, wantitle,false,true);
			areaNums[1] = new AreaNum(11,10,1, 11, BallResId, 0, 1,Color.RED, qiantitle,false,true);
		}else if(state.equals("Q3")){
			areaNums = new AreaNum[3];
			areaNums[0] = new AreaNum(11,10,1, 11, BallResId, 0, 1,Color.RED, wantitle,false,true);
			areaNums[1] = new AreaNum(11,10,1, 11, BallResId, 0, 1,Color.RED, qiantitle,false,true);
			areaNums[2] = new AreaNum(11,10,1, 11, BallResId, 0, 1,Color.RED, baititle,false,true);

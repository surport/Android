...
public class TenActivity extends Dlc{
	...
	public AreaNum[] initArea() {
		...
		if(state.equals("S1")){
			...
			areaNums[0] = new AreaNum(20,10,1, 20, BallResId, 0, 1,Color.RED, wantitle,false,true);
			areaNums[1] = new AreaNum(20,10,1, 20, BallResId, 0, 1,Color.RED, qiantitle,false,true);
		}else if(state.equals("Q3")){
			areaNums = new AreaNum[3];
			areaNums[0] = new AreaNum(20,10,1, 20, BallResId, 0, 1,Color.RED, wantitle,false,true);
			areaNums[1] = new AreaNum(20,10,1, 20, BallResId, 0, 1,Color.RED, qiantitle,false,true);
			areaNums[2] = new AreaNum(20,10,1, 20, BallResId, 0, 1,Color.RED, baititle,false,true);
	...
	public void turnHosity() {
		Intent intent = new Intent(this,HighFrequencyNoticeHistroyActivity.class);

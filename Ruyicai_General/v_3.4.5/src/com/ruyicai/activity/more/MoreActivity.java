...
//	private CompanyInfo  companyInfo = new CompanyInfo(this);//公司简介
    ...
    RelativeLayout kaijiangdingyue,personidset,weibobangding;//设置界面 开奖订阅和个人帐号设置
...
//		appc=(ApplicationContext)getApplication();
		Constants.shareContent ="Hi，我刚使用了如意彩手机客户端买彩票，很方便呢！" +
				"你也试试吧，彩票随身投，大奖时时有！中奖了记的要请客啊！下载地址:http://wap.ruyicai.co m/w/client/download.jspx";
	}

...
public class BetQueryActivity  extends Activity implements HandlerMsg{
	...
	private String [] allcountries={"全部彩种","双色球","福彩3D","江西11选5","广东11选5","大乐透","时时彩","七乐彩","排列三","竞彩足球","排列5","七星彩","11运夺金","竞彩篮球","22选5","胜负彩","任选九","六场半","进球彩"};
	private int allpages=0,ssqpages=0,dpages=0,xuanpages=0,dltpages=0,sscpages=0,qlcpages=0,plspages=0,jczqpages=0,plwpages=0,qxcpages=0,djpages=0,jclqpages=0,twentypages=0,sfcpages=0,rxjpages=0,lcbpages=0,jqcpages=0,gdpages=0;
	private int allindex=0,ssqindex=0,dindex=0,xuanindex=0,dltindex=0,sscindex=0,qlcindex=0,plsindex=0,jczqindex=0,plwindex=0,qxcindex=0,djindex=0,jclqindex=0,twentyindex=0,sfcindex=0,rxjindex=0,lcbindex=0,jqcindxe=0,gdindex=0;
	String jsonString;
...
//				queryinfolist.removeFooterView(view);
	...
	public void lookDetailDialog(final BetQueryInfo info){
		...
		final String playFashion = (String) info.getPlay();
...
//						alert(buyAgainMessage+"");
	...
	private void showagaindialog(final BetQueryInfo info){
	  ...
	  submit.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			Toast.makeText(BetQueryActivity.this, "请输入数字", Toast.LENGTH_SHORT).show();	
			}else if(Integer.valueOf(beishu)>200){
				Toast.makeText(BetQueryActivity.this, "不能超过200倍", Toast.LENGTH_SHORT).show();	
			}else{
				...
				if(lotno.equals("J00001")||lotno.equals("J00002")||lotno.equals("J00003")||lotno.equals("J00004")||lotno.equals(Constants.LOTNO_JCLQ)||lotno.equals(Constants.LOTNO_JCLQ_DXF)||lotno.equals(Constants.LOTNO_JCLQ_RF)||lotno.equals(Constants.LOTNO_JCLQ_SFC)){
					...
					.append(getString(R.string.usercenter_winprize_payMoney)).append(Integer.valueOf(amount)/Integer.valueOf(lotMulti)*Integer.valueOf(beishu)/100+"元").append("\n\n")
				...
				alert(buyAgainMessage.toString());
				dialog.dismiss();
			}
	...
	private void initBetPojo(String zhuma,String lotno,String amount,String beishu,String lomit) {
		initPojo();

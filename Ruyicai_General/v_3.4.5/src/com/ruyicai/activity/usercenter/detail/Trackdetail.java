...
public class Trackdetail extends ActionActivity {
	...
	void init() {
		...
		trackState(statetext,trackState,lastNums);
	...
	public class Tracklookadapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			str.append("期号:").append(batchcode).append("\n").append("倍数:")
					...
					.append(PublicMethod.toIntYuan(prizeAmt)).append("元")
					.append("\n");
			...
			for (int i = 0; i < winprizejson.length(); i++) {
				try {
					...
					winPrizeQueryinfo.setPrizeAmt(winprizejson.getJSONObject(i)
							.getString("prizeAmt"));
					winPrizeQueryinfo.setDesc(winprizejson.getJSONObject(i)
							.getString("desc"));
	...
	public void setListViewHeightBasedOnChildren(ListView listView) {  
	    ...
	    params.height = PublicMethod.getPxInt(185, Trackdetail.this) * (listAdapter.getCount());  

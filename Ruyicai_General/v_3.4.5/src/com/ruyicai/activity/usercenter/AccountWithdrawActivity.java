...
//查询提现记录
	...
	protected void getDialogZFB() {
		...
		final TextView bankText = (TextView) getView.findViewById(R.id.get_money_bank_num_text);
		 ...
		 password = (EditText) getView.findViewById(R.id.get_money_password_edit);
...
//				String bankAreaStr = money_bank_start.getText().toString();
	...
	"4、银行卡提现不收取手续费。用工商、农业、建设、招商银行的银行卡16:00前的提款申请：当天到账；16:00后的提款申请：第二天到账。使用其它银行卡的提现，到账时间加一天。如有疑问，请致电客服热线：4006651000或01088860239";
	/**
	 * 提现窗口
	 */

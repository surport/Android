...
//	
    ...
    */
	...
	public static BallTable makeBallTable(TableLayout tableLayout, int aFieldWidth,int aBallNum, int[] aResId, int aIdStart, int aBallViewText, boolean isplw,
	    Context context,int isNum,List<String> missValues,OnClickListener onclick) {
		TableLayout tabble = tableLayout;
		BallTable iBallTable = new BallTable(aIdStart,context);
		int iBallNum = aBallNum;
...
//		return String.valueOf(Integer.parseInt(amt)*100);
	 ...
	 * 
	 */
	public static void createStar(LinearLayout starNum,String crown,String cup,String diamond,String star,Context context,int isAbleNum){
			...
			public void afterTextChanged(Editable edit) {
				String text = edit.toString();
				 ...
				 if(text!=null&&!text.equals("")){
					...
					setValueThread(mTextBeishu, handler);
...
//});
	...
	private static void setValueThread(final EditText mTextBeishu,

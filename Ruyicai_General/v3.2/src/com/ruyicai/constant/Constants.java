...
//	public static String LOT_SERVER = "http://192.168.0.114:8000/lotserver/RuyicaiServlet";//金龙
	...
	public static String SOFTWARE_VERSION = "3.2.0.1";	
...
//"MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCZoLkg+X0CT9DwPNxlBzK67zM3jJIxnQ39gR+gW177zyNoc7l9KrApltLkTTMh5nZ8KNY2ss0YnLzwd77/9ODF7M+scCWnSsbjAxG0zVb9rdg+IOH9MUWKFkSaeb7oR6LqXRSPd48a8S4US2HvyQILuLkgNPirqVWHvYJrrJkqJwIDAQAB";
	/**
	 * 用户是否已经登录标示
	 */
...
//	public static String COOP_ID = "100";//联想lephone
//	public static String COOP_ID = "764";//91如意彩
//	public static String COOP_ID = "359";//智汇云
//	public static String COOP_ID = "534";//web 
//	public static String COOP_ID = "643";//安智市场
//	public static String COOP_ID = "641";//安卓市场
//	public static String COOP_ID = "533";//wap官网
//	public static String COOP_ID = "790";//道言道1
//	public static String COOP_ID = "791";//道言道2
//	public static String COOP_ID = "792";//道言道3
//	public static String COOP_ID = "535";//腾讯
//	public static String COOP_ID = "788";//盟友1
//	public static String COOP_ID = "789";//盟友2
//	public static String COOP_ID = "184";//欧了吧
//	public static String COOP_ID = "764";//91安卓
//	public static String COOP_ID = "238";//泡椒
//	public static String COOP_ID = "208";//优亿市场
//	public static String COOP_ID = "561";//飞流下载
//	public static String COOP_ID = "625";//安丰网
//	public static String COOP_ID = "652";//开奇网
//	public static String COOP_ID = "655";//多么市场
//	public static String COOP_ID = "676";//知汇云
//	public static String COOP_ID = "741";//千尺1
//	public static String COOP_ID = "743";//千尺2
//	public static String COOP_ID = "497";//力趣
	public static String COOP_ID = "806";//一马

...
public class AreaNum {
	...
	public AreaNum(int areaNum,int isNum, int areaMin,int chosenBallSum, int ballResId[],int startId, int startText, int textColor, String textView,boolean isJxBtn,boolean isSensor) {
		this.areaNum = areaNum;
		this.isNum = isNum;
	...
	public AreaNum(int areaNum,int isNum, int areaMin,int chosenBallSum, int ballResId[],int startId, int startText, int textColor, String textView,boolean isJxBtn,boolean isSensor,boolean isAgain) {
		this.areaNum = areaNum;
		this.isNum = isNum;
		this.areaMin = areaMin;
		this.chosenBallSum = chosenBallSum;

...
import com.unionpay.upomp.lthj.plugin.ui.R.string;
...
public class HelpTitles extends Activity {
	...
	private void getJSONByLotno() {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				JSONObject jsonObjectByLotno = HelpCenterInterface.getInstance().accountDetailQuery(type);
				try{
					String error_code = jsonObjectByLotno.getString("error_code");
					final String message = jsonObjectByLotno.getString("message");
					 if(error_code.equals("0000")){
						titleList = getList(jsonObjectByLotno);
	...
	private List<Map<String, String>> getList(JSONObject jsonObjectByLotno)

...
public class HistoryNumberActivity extends Activity implements
		OnClickListener {
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case GET_LOSSVALUE_ERROR:
				Toast.makeText(HistoryNumberActivity.this,
...
//				.setSelectedNumbersTextView(selectedNumbersTextView);
	...
	private void addViewAndTouZhu(int redSize, int blueSize) {
		...
		if (betNums > 10000) {
			...
			Intent intent = new Intent(HistoryNumberActivity.this,
					OrderDetails.class);
	...
	public void dialogExcessive(int maxNums) {
		AlertDialog.Builder builder = new AlertDialog.Builder(
				HistoryNumberActivity.this);
		builder.setTitle(HistoryNumberActivity.this.getString(

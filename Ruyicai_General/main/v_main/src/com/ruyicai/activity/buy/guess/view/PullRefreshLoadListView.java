 ...
 * @author Maxwin
 * @description An ListView support (a) Pull down to refresh, (b) Pull up to load more. Implement IXListViewListener, and see stopRefresh() / stopLoadMore().
 */
...
public class PullRefreshLoadListView extends ListView implements OnScrollListener {
	...
	public PullRefreshLoadListView(Context context, AttributeSet attrs, int defStyle) {

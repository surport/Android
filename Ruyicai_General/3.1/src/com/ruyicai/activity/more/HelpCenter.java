	   ...
	   public View showView(){
		...
		OnItemClickListener clickListener = new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				/* 功能指引 */
				if ("功能指引".equals(str)) {
//					setContentView(showInfoView(ID_GAMEINTRODUTION));
					Intent intent =new Intent(HelpCenter.this,GongNZY.class);	
					startActivity(intent);
					}
				/* 特色功能 */
				if ("特色功能".equals(str)) {
//					setContentView(showInfoView( ID_ZHONGJIANG));
					Intent intent =new Intent(HelpCenter.this,TeSGN.class);	
					startActivity(intent);
				}
				/* 常见问题 */
				if ("常见问题".equals(str)) {
//					setContentView(showInfoView(ID_GOUCAI));
					Intent intent =new Intent(HelpCenter.this,ChangJWT.class);	
					startActivity(intent);
				}
				/* 彩票术语 */
				if ("彩票术语".equals(str)) {
//					setContentView(showInfoView(ID_MIMAZHAOHUI));
					Intent intent =new Intent(HelpCenter.this,CaiPSY.class);	
					startActivity(intent);
				}if("彩票玩法".equals(str)){
//					setContentView(showInfoView(ID_ABOUT));
					Intent intent =new Intent(HelpCenter.this,LotteryGame.class);
					startActivity(intent);
				}
			}
	   ...
	   protected View showInfoView(int aInfoFlag) {
		   isMain = false;
			...
			case ID_KEFUDIANHUA:
				...
				break;
			case ID_ABOUT :
				iFileName = "ruyihelper_about.html";
				title.setText("关于软件");
			}

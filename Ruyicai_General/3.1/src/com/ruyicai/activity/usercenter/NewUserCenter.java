  ...
  //如果昵称未设置点击事件  
   ...
   /**
	...
	protected List<Map<String, Object>> getListForUsermonyeAdapter() {
		String[] usercenterQueryInfoTitles = { "账户充值",
				"账户提现",
				"账户明细",
				"资金详情",
				"我的积分" };
		int[] usercenterQueryInfoIcons = {R.drawable.putinmoney,R.drawable.tixianw,
				R.drawable.zhanghumingxi,R.drawable.zijinxiangqing,R.drawable.usercroe};
	...
	protected List<Map<String, Object>> getListForAccountAdapter() {
		String[] titles = {"中奖查询","投注记录","追号查询","赠彩查询","我的合买"};
		int[] accountDetailInfoIcons = {R.drawable.zhoangjiangchaxun,
				R.drawable.touzhujilu,
				R.drawable.zhuihaochaxun,R.drawable.zengcaichaxun,R.drawable.wodehemai};
		List<Map<String, Object>> list = new ArrayList<Map<String, Object>>(2);
	...
	protected List<Map<String, Object>> getListForusersetAdapter() {
		...
		int[] accountDetailInfoIcons = {R.drawable.mimaxiugai,
				R.drawable.sfzbd,
				R.drawable.mobilebindlable,R.drawable.myliuyan};
		List<Map<String, Object>> list = new ArrayList<Map<String, Object>>(2);
		for (int i = 0; i < titles.length; i++) {
			Map<String, Object> map = new HashMap<String, Object>();
			map.put(TITLE, titles[i]);

	...
	public void onCheckAction(int checkedId) {
		...
		case 0:
			...
			areaNums[0] = new AreaNum(10, 10, 1, 11, BallResId, 0, 0,
					Color.RED, wantitle, false, true);
			areaNums[1] = new AreaNum(10, 10, 1, 11, BallResId, 0, 0,
					Color.RED, qiantitle, false, true);
			areaNums[2] = new AreaNum(10, 10, 1, 11, BallResId, 0, 0,
					Color.RED, baititle, false, true);
			areaNums[3] = new AreaNum(10, 10, 1, 11, BallResId, 0, 0,
					Color.RED, shititle, false, true);
			areaNums[4] = new AreaNum(10, 10, 1, 11, BallResId, 0, 0,
		...
		case 1:
			...
			areaNums[0] = new AreaNum(10, 10, 1, 9, BallResId, 0, 0, Color.RED,
					wantitlet, false, true);
			areaNums[1] = new AreaNum(10, 10, 1, 9, BallResId, 0, 0, Color.RED,
					qiantitlet, false, true);
			areaNums[2] = new AreaNum(10, 10, 1, 9, BallResId, 0, 0, Color.RED,
					baititlet, false, true);
			areaNums[3] = new AreaNum(10, 10, 1, 9, BallResId, 0, 0, Color.RED,
					shititlet, false, true);
			areaNums[4] = new AreaNum(10, 10, 1, 9, BallResId, 0, 0, Color.RED,
					getitlet, false, true);

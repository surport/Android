...
//		Log.v("isonKey", isonkey);
	...
	class AccountAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			holder.isfreeHanding.setHint(alertStr);
			return convertView;
		}
		class ViewHolder{
			TextView title;
    ...
    protected Dialog createBankCardPhoneDialogNo(){
		...
		String phonenum = pre.getUserLoginInfo("mobileid");
...
//    //第一次DNA充值绑定弹出框
    ...
    //支付宝充值
 	...
 	private void beginRegisterBankPhoneCard(View vi) {
 		...
 		final String phonenum = shellRW.getUserLoginInfo("mobileid");
   ...
   private boolean isCardString(String cardNumber) {
	...
	/**
 	...
 	public void  checkDNA() {
 		...
 		final String mobile = pre.getUserLoginInfo("mobileid");
 		phonenum = mobile;
    ...
    private void recharge(final RechargePojo rechargepojo) {
		...
		phonenum = pre.getUserLoginInfo("mobileid");
    ...
    public class AccountMainItemListener implements OnItemClickListener{
	    ...
	    public void onItemClick(AdapterView<?> parent, View view, int position,
			...
			if (context.getString(R.string.bank_cards_recharge).equals(textString)) {
			  ...
			  createPhoneBankRechargeDialog().show();
			} else if (context.getString(R.string.yin_bank_cards_recharge).equals(textString)) {

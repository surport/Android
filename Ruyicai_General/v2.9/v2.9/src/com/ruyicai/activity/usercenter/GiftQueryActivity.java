...
import com.ruyicai.activity.usercenter.AccountDetailsActivity.AccountQueryAdapter;
import com.ruyicai.net.GiftReciveInterface;
...
//				queryinfolist.removeFooterView(view);
	 ...
	 * @return
	 */
//	  public List<Map<String, Object>> initAdapterlist(int pageindex,List<Vector> giftdatalist,int giftorgifted){
//		  List<Map<String, Object>> list = new ArrayList<Map<String, Object>>(2);
//		  	int listid=pageindex-1;
//		  	for(int j=0;j<giftdatalist.size();j++){
//			for (int i = 0; i < giftdatalist.get(j).size(); i++) {
//				Map<String, Object> map = new HashMap<String, Object>();
//				map.put(ISGIFT, giftorgifted);
//				map.put(LOTMULTI, ((GIftQueryInfo) giftdatalist.get(j).get(i)).getLotMulti());
//				map.put(BETCODE, ((GIftQueryInfo) giftdatalist.get(j).get(i)).getBetCode());
//				map.put(LOTNO, ((GIftQueryInfo) giftdatalist.get(j).get(i)).getLotNo());
//				map.put(AMOUNT, ((GIftQueryInfo) giftdatalist.get(j).get(i)).getAmount());
//				map.put(ORDERTIME, ((GIftQueryInfo) giftdatalist.get(j).get(i)).getOrderTime());
//				map.put(BATCHCODE, ((GIftQueryInfo) giftdatalist.get(j).get(i)).getBatchCode());
//				map.put(USERNO, ((GIftQueryInfo) giftdatalist.get(j).get(i)).getUserNo());
//				map.put(STATE, ((GIftQueryInfo) giftdatalist.get(j).get(i)).getReciveState());
//				map.put(ID, ((GIftQueryInfo) giftdatalist.get(j).get(i)).getId());
//				list.add(map);
//			}
//		  	}
//			return list;
...
//				}
	...
	public void getCodeNet(final String id){
		...
		new Thread(new Runnable() {
			...
			public void run() {
				// TODO Auto-generated method stub
				String returnStr = GiftReciveCodeInterface.getInstance().giftCodeQuery(id);
				dialog.dismiss();
				try {

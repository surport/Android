...
public class HadBindedPhoneOrUnBindPhone extends Activity{
	...
	Handler handler = new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			case 1://解除绑定手机号成功
				...
				Toast.makeText(HadBindedPhoneOrUnBindPhone.this, (String) msg.obj, Toast.LENGTH_LONG).show();
				shellRW.setUserLoginInfo("mobileid", "");
				finish();
				break;
			case 2://失败
				progressDialog.dismiss();
	...
	private void Unbind(){
		...
		new Thread(new Runnable() {
			public void run() {
				String bindIDback = BindPhoneInterface.getInstance().unBind( phonenum, userno);
					try {

...
public class BetQueryActivity  extends Activity implements HandlerMsg{
	...
	private String [] allcountries={"全部彩种","双色球","福彩3D","11选5","大乐透","时时彩","七乐彩","排列三","竞彩足球","排列5","七星彩","11运夺金","竞彩篮球"};
	private int allpages=0,ssqpages=0,dpages=0,xuanpages=0,dltpages=0,sscpages=0,qlcpages=0,plspages=0,jczqpages=0,plwpages=0,qxcpages=0,djpages=0,jclqpages=0;
	private int allindex=0,ssqindex=0,dindex=0,xuanindex=0,dltindex=0,sscindex=0,qlcindex=0,plsindex=0,jczqindex=0,plwindex=0,qxcindex=0,djindex=0,jclqindex=0;
	String jsonString;
	...
	public class WinPrizeAdapter extends BaseAdapter {
		...
		private LayoutInflater mInflater; // 扩充主列表布局
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				int  isJC = 0;
				if(lotno.equals("J00001")||lotno.equals("J00005")){
					isJC = 1;
				}else{
					isJC = 0;
				}

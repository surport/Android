...
public class FootballChooseNineLottery extends FootballFourteen implements OnSeekBarChangeListener,HandlerMsg{
	...
	String re;
	private static List<TeamInfo> teamInfos = new LinkedList<TeamInfo>();
...
//		footBallList.set
		...
		title.setText(R.string.renxuanjiu);
		createView();
		isGetData();
	}
    /**
	...
	public void beginTouZhu() {
		int iZhuShu = getZhuShu();
		ShellRWSharesPreferences pre = new ShellRWSharesPreferences(FootballChooseNineLottery.this,"addInfo");

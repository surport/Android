...
public class FootballSixSemiFinal extends FootBallLotteryFather implements OnClickListener, OnSeekBarChangeListener,HandlerMsg{
	...
	public void onCreate(Bundle savedInstanceState){
		...
		initView();
		title.setText(R.string.liuchangban);
		...
		if(rx9LotnoInfo!=null){
			...
			// 没有获取到期号信息,重新联网获取期号
		    PublicMethod.getIssue(Constants.LOTNO_LCB,issue,time,new Handler());
		}
	...
	String batchCode;
	String re;
	public static Vector<TeamInfo> teamInfos = new Vector<TeamInfo>();
	...
	public void beginTouZhu() {
		int iZhuShu = getZhuShu();
		ShellRWSharesPreferences pre = new ShellRWSharesPreferences(FootballSixSemiFinal.this,"addInfo");

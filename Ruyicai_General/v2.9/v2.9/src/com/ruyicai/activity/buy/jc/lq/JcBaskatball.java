...
import com.ruyicai.activity.buy.jc.JcMain;
import com.ruyicai.activity.buy.jc.lq.Lq.Info;
import com.ruyicai.activity.buy.jc.zq.Jc;
import com.ruyicai.util.Constants;


public class JcBaskatball extends JcMain {
	...
	public void isTouZhuNet() {		
		...
		if(iZhuShu>0){
			if(isAmtDialog()){
				...
				betAndGift.setLotno(Constants.LOTNO_JCLQ);
	...
	public class JcInfoAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			holder.btn1.setText("主负"+info.getFail());
			holder.btn2.setVisibility(Button.GONE);
			holder.btn3.setText("主胜"+info.getWin());
		    LinearLayout.LayoutParams imagebtn_params = new LinearLayout.LayoutParams(130, 40);
		    holder.btn1.setLayoutParams(imagebtn_params);
		    holder.btn3.setLayoutParams(imagebtn_params);
		    holder.btn3.setPadding(10,0, 0, 0);
			if (info.isFail()) {

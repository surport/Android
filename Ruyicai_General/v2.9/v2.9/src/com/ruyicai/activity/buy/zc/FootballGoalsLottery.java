...
public class FootballGoalsLottery extends FootBallLotteryFather implements OnClickListener, OnSeekBarChangeListener,HandlerMsg{
	...
	private static Vector<TeamInfo> teamInfos = new Vector<TeamInfo>();
	...
	public void onCreate(Bundle savedInstanceState){
		...
		title.setText(R.string.jinqiucai);
		createVeiw();
		isGetData();
	}
    /**
	...
	public void getData() {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				String footballTeamJSON = FootballInterface.getInstance().getZCData(qihaoxinxi[2], qihaoxinxi[0]); // 传入参数
				try {
	...
	private void initBetPojo() {
		ShellRWSharesPreferences pre = new ShellRWSharesPreferences(FootballGoalsLottery.this, "addInfo");

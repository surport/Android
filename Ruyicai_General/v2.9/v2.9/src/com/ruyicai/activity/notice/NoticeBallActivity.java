...
public class NoticeBallActivity extends Activity{
	...
	public void noticeAllNet(final boolean isRed){
		if(NoticePrizesOfLottery.isFirstNotice){
	...
	public void addBallView(boolean isRed) {
		...
		case NoticeActivityGroup.ID_SUB_SHUANGSEQIU_LISTVIEW:
			...
			if(isRed){
				ballView.initNoticeBall(list.size(),33, 1, list,isRed,"ssq",1*NoticePrizesOfLottery.SCALE);
			}else{
				ballView.initNoticeBall(list.size(),16, 1, list,isRed,"ssq",1*NoticePrizesOfLottery.SCALE);
			}
		...
		case NoticeActivityGroup.ID_SUB_FUCAI3D_LISTVIEW:
			...
			ballView.initNoticeBall(list.size(),10, 0, list,isRed,"fc3d",1*NoticePrizesOfLottery.SCALE);
			layout.addView(ballView);
			break;
		case NoticeActivityGroup.ID_SUB_QILECAI_LISTVIEW:
			...
			if(isRed){
				ballView.initNoticeBall(list.size(),30, 1, list,isRed,"qlc",1*NoticePrizesOfLottery.SCALE);
			}else{
				ballView.initNoticeBall(list.size(),30, 1, list,isRed,"qlc",1*NoticePrizesOfLottery.SCALE);
			}
			layout.addView(ballView);
		...
		case NoticeActivityGroup.ID_SUB_PAILIESAN_LISTVIEW:
			...
			ballView.initNoticeBall(list.size(),10, 0, list,isRed,"pl3",1*NoticePrizesOfLottery.SCALE);
			layout.addView(ballView);
			break;
		case NoticeActivityGroup.ID_SUB_PL5_LISTVIEW:
			...
			ballView.initNoticeBall(list.size(),10, 0, list,isRed,"pl5",1*NoticePrizesOfLottery.SCALE);
			layout.addView(ballView);
			break;
		case NoticeActivityGroup.ID_SUB_QXC_LISTVIEW:
			...
			ballView.initNoticeBall(list.size(),10, 0, list,isRed,"qxc",1*NoticePrizesOfLottery.SCALE);
			layout.addView(ballView);
			break;
		case NoticeActivityGroup.ID_SUB_DLT_LISTVIEW:
			...
			if(isRed){
				ballView.initNoticeBall(list.size(),35, 1, list,isRed,"cjdlt",1*NoticePrizesOfLottery.SCALE);
			}else{
				ballView.initNoticeBall(list.size(),12, 1, list,isRed,"cjdlt",1.3*NoticePrizesOfLottery.SCALE);
			}
			layout.addView(ballView);
			break;
		case NoticeActivityGroup.ID_SUB_SHISHICAI_LISTVIEW:
			...
			ballView.initNoticeBall(list.size(),10, 0, list,isRed,"ssc",1*NoticePrizesOfLottery.SCALE);
			layout.addView(ballView);
			break;
		case NoticeActivityGroup.ID_SUB_DLC_LISTVIEW:
			...
			ballView.initNoticeBall(list.size(),11, 1, list,isRed,"11-5",1.3*NoticePrizesOfLottery.SCALE);
			layout.addView(ballView);
			break;
		case NoticeActivityGroup.ID_SUB_YDJ_LISTVIEW:
			...
			ballView.initNoticeBall(list.size(),11, 1, list,isRed,"11-ydj",1.3*NoticePrizesOfLottery.SCALE);
			layout.addView(ballView);
			break;

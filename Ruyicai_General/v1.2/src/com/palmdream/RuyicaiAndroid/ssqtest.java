...
public class ssqtest extends Activity // 事件 回调函数
	...
	private static final int DIALOG1_TOUZHU = 1;// 进度条的值2010/7/4
				...
				.setMessage(string).setPositiveButton("确定",
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
								...
								showDialog(DIALOG1_TOUZHU); // 显示网络提示框 2010/7/4
								// TODO Auto-generated method stub
								// 加入是否改变切入点判断 陈晨 8.11
	...
	private void alert_dantuo(String string) {
		...
		Builder dialog = new AlertDialog.Builder(this).setMessage(string)
				.setPositiveButton("确定", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						showDialog(DIALOG1_TOUZHU); // 显示网络提示框
						// 加入是否改变切入点判断 陈晨 8.11
						iHttp.whetherChange = false;
						// TODO Auto-generated method stub
						Thread t = new Thread(new Runnable() {
		...
		ssq_b_touzhu_danshi.setImageResource(R.drawable.touzhuup);
		dialog.show();
	...
	protected Dialog onCreateDialog(int id) {
		...
		case DIALOG1_TOUZHU:
			progressdialog = new ProgressDialog(this);
			// progressdialog.setTitle("Indeterminate");
			progressdialog.setMessage("投注信息已提交，请稍候...");
			progressdialog.setIndeterminate(true);
			progressdialog.setCancelable(true);
			break;

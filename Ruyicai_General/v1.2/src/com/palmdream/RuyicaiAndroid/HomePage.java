...
//		private int iShowStringX = 100;//圣诞提示语位置
//		private int iShowStringY = 451;//圣诞提示语位置
//		private int iShowStringX = 180;//宏珩手机内置位置
//		private int iShowStringY = 290;//宏珩手机内置位置
		...
		public MyAnimateView(Context context) {
			...
			Animation an = new TranslateAnimation(iOffsetX + 58,iOffsetX + 242, iOffsetY + 366, iOffsetY + 366);
//			Animation an = new TranslateAnimation(iOffsetX + 58,iOffsetX + 244, iOffsetY + 431, iOffsetY + 431);//圣诞版滚动条图片位置
//			Animation an = new TranslateAnimation(iOffsetX + 141,iOffsetX + 322, iOffsetY + 260, iOffsetY + 260);//宏珩手机内置滚动条图片位置
			an.setDuration(1000);
			an.setRepeatCount(-1);

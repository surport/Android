...
public class ChooseNumberDialogPL3 extends Dialog implements OnClickListener,
		...
		if (iWhichLayout == 4) {
			...
			ZhixuanHezhiAddBtn
					.setOnClickListener(new ImageButton.OnClickListener() {
						...
						@Override
						public void onClick(View v) {
							mSeekBarZhixuanHezhi
									.setProgress(++iProgressZhixuanHezhi);
						}
	...
	public void onClick(View v) {
		...
		case R.id.zhixuanhezhi_okButton: {
			int[] iReturn = { iProgressZhixuanHezhi, iProgressZhixuanHezhi,
					iProgressZhixuanHezhi };
			iListener.onOkClick(iReturn);
			dismiss();
			break;
		}
		...
		case R.id.zu3hezhi_okButton: {
			int[] iReturn = { iProgressZu3Hezhi, iProgressZu3Hezhi,
					iProgressZu3Hezhi };
			iListener.onOkClick(iReturn);
			dismiss();
			break;
		...
		case R.id.zu6hezhi_okButton: {
			int[] iReturn = { iProgressZu6Hezhi, iProgressZu6Hezhi,
					iProgressZu6Hezhi };
			iListener.onOkClick(iReturn);
			dismiss();
			break;

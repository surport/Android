...
public class QLC extends Activity // 事件 回调函数
	...
	private void beginTouZhu() {
		...
		if (iCurrentButton == PublicConst.BUY_QLC_DANSHI) {
			...
			if (sessionIdStr.equals("")) {
				...
				qlc_b_touzhu_danshi.setImageResource(R.drawable.touzhuup_n);
				String sTouzhuAlert = "";
			...
			if (sessionIdStr.equals("")) {
				...
				qlc_b_touzhu_fushi.setImageResource(R.drawable.touzhuup_n);
				String sTouzhuAlert = "";
				sTouzhuAlert = getTouzhuAlert();
				alert(sTouzhuAlert);
			}
			...
			if (sessionIdStr.equals("")) {
				...
				qlc_b_touzhu_dantuo.setImageResource(R.drawable.touzhuup_n);
				String sTouzhuAlert = "";
				sTouzhuAlert = getTouzhuAlert();
	...
	private void alert(String string) {
		...
		// if (iCurrentButton == PublicConst.BUY_QLC_DANSHI) {
		// qlc_b_touzhu_danshi.setImageResource(R.drawable.touzhuup);
		// } else if (iCurrentButton == PublicConst.BUY_QLC_FUSHI) {
		// qlc_b_touzhu_fushi.setImageResource(R.drawable.touzhuup);
		// }
		dialog.show();

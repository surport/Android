...
public class FC3DTest extends Activity implements OnClickListener,
	...
	private ImageButton b_touzhu_ddd_zhixuanzu6;
	private ImageButton b_touzhu_ddd_zhixuanzu3;
	Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case 10:
				...
				// if (iCurrentButton == PublicConst.BUY_FC3D_HEZHI_ZU3) {
				// b_touzhu_ddd_zhixuanzu3
				// .setImageResource(R.drawable.touzhuup);
				//
				// } else if (iCurrentButton == PublicConst.BUY_FC3D_HEZHI_ZU6)
				// {
				// b_touzhu_ddd_zhixuanzu6
				// .setImageResource(R.drawable.touzhuup);
				//
				// }
				break;
	...
	private void create_FC3D_HEZHI_ZU6() {
		...
		if (buyView.findViewById(R.id.fc3d_hezhi_zu6_linearlayout) == null) {
					...
					R.layout.layout_fc3d_hezhi_zu6, null);
			{
				...
				// b_touzhu_ddd_zhixuanzu6 = (ImageButton) iV
	...
	private void create_FC3D_HEZHI_ZU3() {
		...
		if (buyView.findViewById(R.id.fc3d_hezhi_zu3_linearlayout) == null) {
					...
					R.layout.layout_fc3d_hezhi_zu3, null);
			{
				...
				// b_touzhu_ddd_zhixuanzu3 = (ImageButton) iV
				...
				.setMessage(string).setPositiveButton("确定",
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
									int which) {
								// if (iCurrentButton ==
								// PublicConst.BUY_FC3D_HEZHI_ZU3) {
								// b_touzhu_ddd_zhixuanzu3.setClickable(false);
								// b_touzhu_ddd_zhixuanzu3
								// .setImageResource(R.drawable.touzhuup_n);
								// Log.e("00000", "====");
								// } else if (iCurrentButton ==
								// PublicConst.BUY_FC3D_HEZHI_ZU6) {
								// b_touzhu_ddd_zhixuanzu6.setClickable(false);
								// b_touzhu_ddd_zhixuanzu6
								// .setImageResource(R.drawable.touzhuup_n);
								// Log.e("111111", "====");
								// }

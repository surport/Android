...
public class RuyiExpressFeelSsqZixuan extends Activity implements
	...
	BallTable SSQRedZhixuanBallTable = null;// 红球区
	BallTable SSQBlueZhixuanBallTable = null;// 篮球区
	...
	protected void onCreate(Bundle savedInstanceState) {
...

		{
			...
			SSQRedZhixuanBallTable = makeBallTable(iV,
					R.id.table_ssq_zixuan_red, iScreenWidth, redBallViewNum,
					redBallViewWidth, SSQRedBallResId, SSQ_RED_ZIXUAN_START, 1);

			int blueBallViewNum = 16;
			SSQBlueZhixuanBallTable = makeBallTable(iV,
					R.id.table_ssq_zixuan_blue, iScreenWidth, blueBallViewNum,
					redBallViewWidth, SSQBlueBallResId, SSQ_BLUE_ZIXUAN_START,
					1);

...
public class jrtLot {
	...
	// para = URLEncoder.encode(paras.toString());
	// String re =
	// http.getViaHttpConnection(baseUrl+action+";jsessionid="+sessionid+
	...
	public static String addSelect(String mobile_number, String sessionid) {
		...
		try {
			...
			if (re != null && re.length() > 0) {
				...
				// PublicMethod.myOutput("======================="+jsonObject3.
				// length());
				...
				// PublicMethod.myOutput("batchNum="+jsonObject2.getString(
				// "batchNum"));
				// PublicMethod.myOutput("lastNum="+jsonObject2.getString(
				// "lastNum"));
				// PublicMethod.myOutput("beginBatch="+jsonObject2.getString(
				// "beginBatch"));
				// PublicMethod.myOutput("lastBatch="+jsonObject2.getString(
				// "lastBatch"));
	...
	public static String betting(String mobile_code, String bet_code,
		...
		try {
			...
			if (re != null && re.length() > 0) {
				...
				// PublicMethod.myOutput("term_begin_datetime="+obj.getString(
				// "term_begin_datetime"));
				// PublicMethod.myOutput("deposit_sum="+obj.getString(
				// "deposit_sum"));
				// PublicMethod.myOutput("sell_term_code="+obj.getString(
				// "sell_term_code"));
				// PublicMethod.myOutput("valid_term_code="+obj.getString(
				// "valid_term_code"));
	...
	public static String bettingSelect(String sessionid) {// String mobile_code,
		...
		try {
			...
			if (re != null && re.length() > 0) {
				...
				// for(int i=0;i<jsonObject3.length();i++){
				// JSONObject jsonObject2 = jsonObject3.getJSONObject(i);
				// PublicMethod.myOutput("error_code ="+jsonObject2.getString(
				// "error_code"));
				// PublicMethod.myOutput("play_name="+jsonObject2.getString(
				// "play_name"));
				// PublicMethod.myOutput("valid_term_code="+jsonObject2.getString
				// ("valid_term_code"));
				// PublicMethod.myOutput("sell_run_code="+jsonObject2.getString(
				// "sell_run_code"));
				// PublicMethod.myOutput("sell_datetime="+jsonObject2.getString(
				// "sell_datetime"));
				// //
				// PublicMethod.myOutput("prize_info="+jsonObject2.getString(
				// "prize_info"));
				// PublicMethod.myOutput("win_big_flag="+jsonObject2.getString(
				// "win_big_flag"));
				// PublicMethod.myOutput("abandon_date_time="+jsonObject2.
				// getString("abandon_date_time"));
				// PublicMethod.myOutput("encash_flag="+jsonObject2.getString(
				// "encash_flag"));
				// PublicMethod.myOutput("encash_term="+jsonObject2.getString(
				// "encash_term"));
				// PublicMethod.myOutput("cash_date_time="+jsonObject2.getString(
				// "cash_date_time"));
				// PublicMethod.myOutput(
				// "-------------------------------------------------");
				// }
	...
	public static String exit(String mobile_code, String sessionid) {
		...
		try {
			...
			if (re != null && re.length() > 0) {
				...
				// JSONObject obj = new JSONObject(re);
				// PublicMethod.myOutput("______________________________");
				// PublicMethod.myOutput("error_code_exit="+obj.getString(
				// "error_code"));
				// if(obj.getString("error_code").equals("0000")){
	...
	public static String gift(String from_mobile_code, String to_mobile_code,
		...
		try {
			...
			if (re != null && re.length() > 0) {
				...
				// PublicMethod.myOutput("check_code="+obj.getString("check_code"
				// ));
				// PublicMethod.myOutput("to_mobile_code="+obj.getString(
				// "to_mobile_code"));
				//					
				// PublicMethod.myOutput("----------");
				// }
	...
	public static String login(String mobile_code, String password) {
		...
		try {
			...
			if (re != null && re.length() > 0) {
				...
				// PublicMethod.myOutput(reValue);
				// addNumber("13866666660","01-F47101-002-50-01020304050619","10"
				// ,"3",reValue);
				// exit("13866666666",reValue);
				// findUserBalance("13866666671",reValue);
				// changePassword("13866666666", "123456", "654321", reValue);
				// gift("13866666671","13411111112",
				// "01-F47101-001-10-01020304050602","20",reValue);
				// betting("13866666671","01-F47101-001-50-01020304050612","100",
				// reValue);
	...
	public static String register(String mobile_code, String user_password,
		...
		// String channel_id="C10152";//优异市场1
		// String channel_id="C10151";//优异市场2
		// String channel_id="C10150";//优异市场3
		// String channel_id="C10149";//优异市场4
		// String channel_id="C10148";//优异市场5
		// String channel_id="C10153";//安智网
		// String channel_id = "C10155";// 奇虎360
		// String channel_id = "C10157";// 水果小游戏android
		// String channel_id = "C10158";// 电玩巴士
		// String channel_id = "C10159";// 3721免费网址大全a
		// String channel_id = "C10161";// 泡椒1
		// String channel_id = "C10163";// 宇龙酷派-推荐
		// String channel_id = "C10164";// N多网
		// String channel_id = "C10171";// 指南针a
		// String channel_id = "C10173";// 咔咔游戏a
		// String channel_id = "C10175";// 九牛7
		// String channel_id = "C10124";// 泡椒android
		// String channel_id = "C10119";// tompda-android
		// String channel_id = "C10147";// 机锋活动
		// String channel_id = "C10153";// 安智网
		// String channel_id = "C10116 ";// 哇棒-电信
		// String channel_id = "C10106";// 谷歌
		// String channel_id = "C10093";// 欧乐吧
		// String channel_id = "C10082";// 优视android 91android：
		// String channel_id = "C10074";// 91android
		// String channel_id = "C10071";// 安卓市场
		// String channel_id = "C10214";// 乐淘a
		String channel_id = "C10216";// 卓乐网
		...
		// String channel ="290" ;//优异市场1
		// String channel ="289" ;//优异市场2
		// String channel ="288" ;//优异市场3
		// String channel ="287" ;//优异市场4
		// String channel ="286" ;//优异市场5
		// String channel ="291" ;//安智网
		// String channel = "293";// 奇虎360
		// String channel = "295";// 水果小游戏android
		// String channel = "298";// 电玩巴士
		// String channel = "299";// 3721免费网址大全a
		// String channel = "301";// 泡椒1
		// String channel = "303";// 宇龙酷派-推荐
		// String channel = "304";// N多网
		// String channel = "317";// 指南针a
		// String channel = "319";// 咔咔游戏a
		// String channel = "327";// 九牛7
		// String channel = "238";// 泡椒android
		// String channel = "232";// tompda-android
		// String channel = "285";// 机锋活动
		// String channel = "291";// 安智网
		// String channel = "226";// 哇棒-电信
		// String channel = "207";// 谷歌
		// String channel = "184";// 欧乐吧
		// String channel = "167";// 优视android
		// String channel = "155";// 91android
		// String channel = "151";// 安卓市场
		// String channel = "384";// 乐淘a
		String channel = "386";// 卓乐网
	...
	public static String findUserBalance(String mobile_code, String sessionid) {
		...
		try {
			...
			if (re != null && re.length() > 0) {
				...
				// );
				// if(obj.getString("error_code").equals("0000")){
				// PublicMethod.myOutput("deposit_amount="+obj.getString(
				// "deposit_amount"));
				// PublicMethod.myOutput("Valid_amount="+obj.getString(
				// "Valid_amount"));
				// }
			}
		} catch (Exception e) {
	...
	public static String winingSelect(String mobile_code, String sessionid) {
		...
		try {
			...
			if (re != null && re.length() > 0) {
				...
				// "error_code"));
				// //
				// PublicMethod.myOutput("check_code="+jsonObject2.getString(
				// "check_code"));
				// PublicMethod.myOutput("play_name="+jsonObject2.getString(
				// "play_name"));
				// PublicMethod.myOutput("district_code="+jsonObject2.getString(
				// "district_code"));
				// PublicMethod.myOutput("sell_datetime="+jsonObject2.getString(
				// "sell_datetime"));
				// PublicMethod.myOutput("sell_run_code="+jsonObject2.getString(
	...
	public static String lotterySelect(String play_name) {
		...
		try {
			...
			// PublicMethod.myOutput("-------------------url"+baseUrl+action+
			// ";jsessionid="
			// +""+"?method="+method+"&jsonString="+para+"&jsonWhere="+where);
			// String re =
			// http.getViaHttpConnection(baseUrl+action+";jsessionid="+""+
			// "?method="+method+"&jsonString="+para+"&jsonWhere="+where);
			...
			if (re != null && re.length() > 0) {
				...
				// ;
				// PublicMethod.myOutput("win_base_code="+obj.getString(
				// "win_base_code"));
				// PublicMethod.myOutput("act_sell_amount="+obj.getString(
				// "act_sell_amount"));
				// PublicMethod.myOutput("valid_sell_amount="+obj.getString(
				// "valid_sell_amount"));
				// }
			}
		} catch (Exception e) {
	...
	public static String giftSelect(String sessionid) {
		...
		try {
			...
			if (re != null && re.length() > 0) {
				...
				// PublicMethod.myOutput("error_code ="+jsonObject2.getString(
				// "error_code"));
				// PublicMethod.myOutput("to_mobile_code="+jsonObject2.getString(
				// "to_mobile_code"));
				// PublicMethod.myOutput("term_begin_datetime="+jsonObject2.
				// getString("term_begin_datetime"));
				// PublicMethod.myOutput("amount="+jsonObject2.getString("amount"
				// ));
				// PublicMethod.myOutput("sell_term_code="+jsonObject2.getString(
				// "sell_term_code"));
				// PublicMethod.myOutput("valid_term_code="+jsonObject2.getString
				// ("valid_term_code"));
				// PublicMethod.myOutput("run_code="+jsonObject2.getString(
				// "run_code"));
				// //
				// PublicMethod.myOutput("check_code="+jsonObject2.getString(
				// "check_code"));
				// PublicMethod.myOutput("bet_code="+jsonObject2.getString(
				// "bet_code"));
				// PublicMethod.myOutput(
				// "-------------------------------------------------");
				// }
	...
	public static String giftedSelect(String sessionid) {
		...
		try {
			...
			if (re != null && re.length() > 0) {
				...
				// PublicMethod.myOutput("error_code ="+jsonObject2.getString(
				// "error_code"));
				// PublicMethod.myOutput("from_mobile_code="+jsonObject2.getString
				// ("from_mobile_code"));
				// PublicMethod.myOutput("term_begin_datetime="+jsonObject2.
				// getString("term_begin_datetime"));
				// PublicMethod.myOutput("amount="+jsonObject2.getString("amount"
	...
	public static String addRequest(String sessionid) {
		...
		try {
			...
			if (re != null && re.length() > 0) {
				...
				// if(obj.getString("error_code").equals("0000"))
				// {
				// PublicMethod.myOutput("addMoneyByBank="+obj.getString(
				// "addMoneyByBank"));
				// PublicMethod.myOutput("addMoneyByPoint="+obj.getString(
				// "addMoneyByPoint"));
				// PublicMethod.myOutput("addMoneyByCard="+obj.getString(
				// "addMoneyByCard"));
				// }
			}
		} catch (Exception e) {
	...
	public static String cardCharge(String mobile_code, String cardNo,
		...
		try {
			...
			if (re != null && re.length() > 0) {
				...
				// {
				// PublicMethod.myOutput("transaction_money="+obj.getString(
				// "transaction_money"));
				// PublicMethod.myOutput("deposit_amount="+obj.getString(
				// "deposit_amount"));
				// PublicMethod.myOutput("valid_amount="+obj.getString(
	...
	public static String bankCharge(String mobile_code, String bankType,
		...
		try {
			...
			if (re != null && re.length() > 0) {
				...
				// PublicMethod.myOutput("pr_NeedResponse="+obj.getString(
				// "pr_NeedResponse"));
				// PublicMethod.myOutput("hmac="+obj.getString("hmac"));
				// PublicMethod.myOutput("nodeAuthorizationURL="+obj.getString(
				// "nodeAuthorizationURL"));
				// PublicMethod.myOutput("--------------============----------");
				// String amp
				// =obj.getString("nodeAuthorizationURL")+"?p0_Cmd="+obj.getString
				// ("p0_Cmd")
				// +"&p1_MerId="+obj.getString("p1_MerId")+"&p2_Order="+obj.
				// getString("p2_Order")
				// +"&p3_Amt="+obj.getString("p3_Amt")+"&p4_Cur="+obj.getString(
				// "p4_Cur")
				// +"&p5_Pid="+obj.getString("p5_Pid")+"&p6_Pcat="+obj.getString(
				// "p6_Pcat")
				// +"&p7_Pdesc="+obj.getString("p7_Pdesc")+"&p8_Url="+obj.
				// getString("p8_Url")
				// +"&p9_SAF="+obj.getString("p9_SAF")+"&pa_MP="+obj.getString(
				// "pa_MP")
				// +"&pd_FrpId="+obj.getString("pd_FrpId")+"&pr_NeedResponse="+obj
				// .getString("pr_NeedResponse")
	...
	public static String wapAttemperRequest(String accesstype,
		...
		try {
			...
			// 219.148.162.70/jrtLot/attemper.do?method="attemperRequest"&
			// jsonString="本地拼好的Json串"。
	...
	public static String tlotterySelect(String play_name) {
		...
		try {
			...
			// +""+"?method="+method+"&jsonString="+para+"&jsonWhere="+where);
			// iStrUrl =
			// baseUrl+action+""+"?method="+method+"&jsonString="+para+"&round="+
			// transctionId
			// +"&key="+PublicMethod.getMD5Str(para+transctionId+privateKey
			// )+"&jsonWhere="+where;
			String re = http.getViaHttpConnection(baseUrl + action + ""
					+ "?method=" + method + "&jsonString=" + para
					+ "&jsonWhere=" + where);// "&round="+transctionId+"&key="+MD5
			// .toMd5(paras.toString()+
			// transctionId+privateKey)+
			// // +";jsessionid="
			// // String re =
			// http.getViaHttpConnection(baseUrl+action+"?method="+method+
			// "&jsonString="+para);
			PublicMethod.myOutput("===============" + re);
			if (re != null && re.length() > 0) {
				reValue = re;
	...
	public static String bettingTC(String mobileCode, String lotNo,
		...
		try {
			...
			para = URLEncoder.encode(paras.toString());
			// para="{mobileCode:\""+mobileCode+"\","+"sessionid:\""+sessionid+
			// "\","
			// +"lotNo:\""+lotNo+"\","+"betCode:\""+betCode+"\","+"lotMulti:\""
			// +lotMulti
			// +"\","+"oneMoney:\""+oneMoney+"\","+"amount:\""+amount+"\"}";
			// para = paras.toString();
			...
			String re = http.getViaHttpConnection(baseUrl + action
					+ ";jsessionid=" + sessionid + "?method=" + method
					+ "&jsonString=" + para);// +"&round="+transctionId+"&key="+
			// MD5.toMd5(
	...
	public static String winingSelectTC(String mobileCode, String startLine,
		...
		try {
			...
			// )+"&jsonWhere="+where;
			// String re =
			// http.getViaHttpConnection(aBaseUrl+action+"?method="+method+
			// "&jsonString="
			// +para+"&round="+transctionId+"&key="+MD5.toMd5(paras
			// .toString()+transctionId+privateKey)+"&jsonWhere="+where);
			String re = http.getViaHttpConnection(baseUrl + action
					+ ";jsessionid=" + sessionid + "?method=" + method
					+ "&jsonString=" + para + "&jsonWhere=" + where);// +"&round="
			// +
			// transctionId
			// +
			// "&key="

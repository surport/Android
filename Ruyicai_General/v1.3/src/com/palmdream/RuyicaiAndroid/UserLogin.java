...
public class UserLogin extends Activity implements TextWatcher {
	...
	private void turnToLogin() {
		...
		// 点击返回按钮，返回上一页
		Button login_return = (Button) findViewById(R.id.login_return_button);
	...
	private void turnToReg() {
		...
		register_button.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// EditText register_id = (EditText)
				// findViewById(R.id.register_id_num_edit);
				...
				// .charAt(register_id_string_len - 1) != 'X'
				// && (register_id_string
				// .charAt(register_id_string_len - 1) > '9' ||
				// register_id_string
				...
				// age = Integer.parseInt("19"+register_id_string.substring(6,
				// 8));
				// }
	...
	private void beginRegister() {
		...
		// EditText register_id_num_edit = (EditText)
		// findViewById(R.id.register_id_num_edit);
		...
		Thread regthread = new Thread(new Runnable() {
			...
			public void run() {
				...
				String error_code = registerInterface.userregister(
						register_phone_num, register_password_,
						"111111111111111111");
				PublicMethod.myOutput("---------" + error_code);
				if (error_code.equals("0000")) {

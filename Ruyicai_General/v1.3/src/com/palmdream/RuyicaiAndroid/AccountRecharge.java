					...
					Thread t = new Thread(new Runnable() {
						...
						public void run() {
							...
							if(phoneCardType==DIANXIN){
								...
								error_code = phonecardChargeInterface.phonecardcharge(
										"C",
										phonenum,
										phoneCardType,
										phoneCardValue,

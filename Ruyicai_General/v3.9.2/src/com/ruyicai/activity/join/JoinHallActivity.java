...
public class JoinHallActivity extends Activity {
	...
	public void initView() {
		...
		for (int i = 0; i < infos.length; i++) {
			...
			View convertView = mInflater.inflate(
					R.layout.join_hall_listview_item, null);
			TextView title = (TextView) convertView
					.findViewById(R.id.join_hall_listview_text_icon_title);
			TextView issue = (TextView) convertView
					.findViewById(R.id.join_hall_listview_text_issue);
			timeText[i] = (TextView) convertView
					.findViewById(R.id.join_hall_listview_text_time);
			ImageView icon = (ImageView) convertView
					.findViewById(R.id.join_hall_listview_img_icon);
			ImageButton join = (ImageButton) convertView
					.findViewById(R.id.join_hall_listview_img_join);
			...
			join.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					Intent intent = new Intent(JoinHallActivity.this,
	...
	class JoinInfo {
		...
		public String getIssue(String type) {
			String issue = "";
			// 获取期号和截止时间
			JSONObject ssqLotnoInfo = PublicMethod
					.getCurrentLotnoBatchCode(type);
	...
	public void isLogin() {
		RWSharedPreferences shellRW = new RWSharedPreferences(
				JoinHallActivity.this, "addInfo");
		String sessionid = shellRW.getStringValue("sessionid");
		if (sessionid == null || sessionid.equals("")) {
			Intent intentSession = new Intent(JoinHallActivity.this,
					UserLogin.class);

...
public class SystemSet {
	...
	public View showView() {
		LayoutInflater inflate = (LayoutInflater) returnPage.getContext()
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		View view = (LinearLayout) inflate.inflate(
				R.layout.ruyihelper_xitongshezhi, null);
		final CheckBox isOnCheck = (CheckBox) view
				.findViewById(R.id.xitongshezhi_check_zhengdong);
		ImageView tvreturn = (ImageView) view
				.findViewById(R.id.tv_choose_luck_lottery_num_return);
		...
		isOnCheck.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton buttonView,
				...
				if (isChecked) {
					...
					isOnCheck.setText(returnPage.getContext().getResources()
							.getString(R.string.xitongshezhi_check_on)
							.toString());
				} else {
					shellRW.putBooleanValue("isOn", false);
					isOnCheck.setText(returnPage.getContext().getResources()
							.getString(R.string.xitongshezhi_check_off)
							.toString());
				}
			}
		});

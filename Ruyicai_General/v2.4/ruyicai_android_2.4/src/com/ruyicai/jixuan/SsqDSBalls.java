...
public class SsqDSBalls extends Balls{
	...
	public void init() {
		...
		int redNum[] = PublicMethod.getRandomsWithoutCollision(6, 0, 32);
		redNum = PublicMethod.orderby(redNum, "abc");
		int blueNum[] = PublicMethod.getRandomsWithoutCollision(1, 0, 15);
		add(redNum,null);
		add(blueNum,"blue");
	}
	/**
...
//        t_str+="-";
		...
		for (int j = 0; j < balls.size(); j++) {
			...
			zhumablue = balls.get(j).getVZhuma().get(1);

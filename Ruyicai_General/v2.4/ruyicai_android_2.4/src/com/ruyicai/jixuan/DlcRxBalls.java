...
public class DlcRxBalls  extends Balls{
	...
	public static String getZhuma(Vector<Balls> balls, String type){
		String str="";
		if(type.equals("R1")){
		    str+="R1|";
	...
	public static String getstrjixuan(Vector<Balls> balls,String typestr){
		String str="";
		for (int i = 0; i < balls.size(); i++) {
		   
			int ge[]= balls.get(i).getVZhuma().get(0);
			int j;

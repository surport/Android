...
public class FC3DZhiXuan extends ZixuanActivity implements
	...
	private void create_FC3D_ZHIXUAN() {
		...
		getMissNet(new Fc3dMissJson(), MissConstant.FC3D_ZX,
				MissConstant.FC3D_ZX);
	}
	...
	private void create_FC3D_HEZHI_ZHIXUAN() {
		...
		getMissNet(new Fc3dMissJson(), MissConstant.FC3D_ZXHZ,
				MissConstant.FC3D_ZXHZ);
	}
	...
	public void isBallTable(int iBallId) {
		...
		case PublicConst.BUY_FC3D_HEZHI_ZHIXUAN:
			...
			areaNums1[0].table.changeBallState(areaNums[0].chosenBallSum,
					iBallId);
			areaNums2[0].table.clearAllHighlights();
			areaNums2[0].table.changeBallState(areaNums[0].chosenBallSum,
					iBallId);
			break;
		case PublicConst.BUY_FC3D_ZHIXUAN:
			int aBallId = iBallId;
			for (int j = 0; j < itemViewArray.size(); j++) {
				...
				if (iBallId >= 0 && iBallId < 10) {
					nBallId = iBallId;
					areaNums[0].table.changeBallState(
							areaNums[0].chosenBallSum, iBallId);
				} else if (iBallId < 20 && iBallId >= 10) {
					nBallId = iBallId - 10;
					areaNums[1].table.changeBallState(

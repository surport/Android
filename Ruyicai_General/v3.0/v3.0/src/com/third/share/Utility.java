...
public class Utility {
    ...
    // 设置http�?如果authParam不为空，则表示当前有token认证信息�?��加入到头�?
    ...
    public static String openUrl(Context context, String url, String method,
            WeiboParameters params,  Token token)  {
        String result = "";
        try {
	...
	public static Token getmToken() {
		return mToken;
	}

	public static void setmToken(Token mToken) {
		Utility.mToken = mToken;
	}

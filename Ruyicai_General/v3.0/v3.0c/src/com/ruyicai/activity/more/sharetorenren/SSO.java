...
public class SSO {
    ...
    /**
     * 使用Single Sign-on功能 完成登录和授�?User-Agent Flow)�?
     * 警告：使用此方法获取返回值请在调用此方法的activity�?重写onActivityResult
    ...
    /**
     * 注意：使用单点登录功能时请务必在调用activity�?重写onActivityResult(int requestCode, int

	...
	public class WinPrizeAdapter extends BaseAdapter {
		...
		private LayoutInflater mInflater; // 扩充主列表布局
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				if(lotno.equals(Constants.LOTNO_JC)||lotno.equals(Constants.LOTNO_JCLQ
				...
				holder.lookdetail.setOnClickListener(new OnClickListener() {
					public void onClick(View v) {
						...
						if(lotno.equals("J00001")||lotno.equals("J00005")||lotno.equals("J00006")||lotno.equals("J00007")||lotno.equals("J00008")){
							if(prize_State.equals("0")){

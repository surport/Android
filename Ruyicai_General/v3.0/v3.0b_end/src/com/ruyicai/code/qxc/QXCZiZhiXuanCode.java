...
public class QXCZiZhiXuanCode extends CodeInterface {
	...
	public String zhuma(AreaNum[] areaNums, int beishu, int type) {
		...
		if (zhuma_firstwei.length > 0 &&zhuma_secondwei.length > 0 &&zhuma_thirdwei.length > 0 
				&& zhuma_fourthwei.length > 0&& zhuma_fifthwei.length > 0&&zhuma_sixthwei.length > 0 &&zhuma_seventhwei.length > 0 ) {

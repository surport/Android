...
public class SscBigSmall extends ZixuanAndJiXuan implements BuyImplement{
	...
	public void onCheckedChanged(RadioGroup group, int checkedId) {
		...
		case 0:
			...
			areaInfos[0] = new AreaInfo(4, 1, BallResId, 0, 0,Color.RED, shititle);
			areaInfos[1] = new AreaInfo(4, 1, BallResId, 0, 0,Color.RED, getitle);
			createView(areaInfos, sscCode,this,BIG_SMALL,true);

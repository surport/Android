...
public class FC3DZhiXuan  extends ZixuanActivity implements BuyImplement, OnCheckedChangeListener{
	...
	private  void create_FC3D_ZHIXUAN(){
		initZXArea();
		createView(areaInfosZ, fc3dCodeZ,this,true);
	...
	private void create_FC3D_HEZHI_ZHIXUAN() {
		...
		createView(areaInfosZH, fc3dCodeH,this,false);

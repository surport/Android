...
import com.ruyicai.activity.buy.jc.lq.view.sf.RfView.JcInfoAdapter;
import com.ruyicai.activity.buy.jc.lq.view.sf.RfView.JcInfoAdapter.ViewHolder;
 ...
 *
 */
public class SfView extends LqMainView{
	
	public SfView(Context context,BetAndGiftPojo betAndGift,Handler handler,LinearLayout layout) {

...
public abstract class ZqMainActivity extends Activity implements SeekBar.OnSeekBarChangeListener,HandlerMsg{
	...
	public void beginTouZhu() {
		RWSharedPreferences pre = new RWSharedPreferences(ZqMainActivity.this, "addInfo");
		sessionId = pre.getStringValue("sessionid");
		phonenum = pre.getStringValue("phonenum");
		userno = pre.getStringValue("userno");
		if (sessionId.equals("")) {
			Intent intentSession = new Intent(ZqMainActivity.this, UserLogin.class);
	...
	public void toActivity(String zhuma){
		  ...
		  Intent intent = new Intent(ZqMainActivity.this, GiftActivity.class);

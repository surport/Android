...
public class BuyActivity extends Activity implements OnClickListener {
	...
	private final Class[] cla = { JoinInfoActivity.class, Ssq.class,Dlt.class,
			Fc3d.class, Ssc.class,Dlc.class,LqMainActivity.class,  Jc.class,Eleven.class,ExpertActivity.class,PL3.class,
	...
	private void dialogMsg() {
		...
		messageflage = shellRW.getStringValue("tanchumessage");
		messageidflag = shellRW.getStringValue("id");

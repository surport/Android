...
public class BalanceQueryActivity extends Activity {
	...
	public void initView() {
		...
		remind = (TextView)findViewById(R.id.usercenter_remind_text);
		remind.setVisibility(TextView.VISIBLE);
		initBalanceInfo();
	...
	private void initBalanceInfo(){
		...
		balanceInfoBuffer.append(getString(R.string.total_balance)).append(totalBalance).append("\n\n")
			.append(getString(R.string.freeze_amout)).append(freeze_amout).append("\n\n")
			.append(getString(R.string.usercenter_currentBalance)).append(deposit_amount).append("\n\n")
			.append(getString(R.string.usercenter_withdrawBalance)).append(Valid_amount).append("\n");

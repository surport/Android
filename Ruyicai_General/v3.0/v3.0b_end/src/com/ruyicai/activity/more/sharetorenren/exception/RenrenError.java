...
package com.ruyicai.activity.more.sharetorenren.exception;
...
public class RenrenError extends RuntimeException {
	...
	/**
	 * 服务器返回的错误代码，详细信息见�?	 * http://wiki.dev.renren.com/wiki/API%E9%94%99%E8%AF%AF%E4
	...
	/**
	 * 将服务器返回的errorMessage转换成SDK定义的易于理解的字符�?	 * 
	 * @param errorCode
	 * 			服务器返回的错误代码
	 * @param errorMessage
	 * 			服务器返回的错误字符串，和错误代码一�?���?	 * @return
	 */
	public static String interpretErrorMessage(int errorCode, String errorMessage) {
		...
		// 上传照片失败
		case 20101:
			// 这里对文案做了�?当修改，使提示信息更加简洁易�?			// errorMessage = "上传照片失败，请稍后重试";
			errorMessage = "请稍后重试";
			break;
		// 上传照片类型错误或未�?		case 20102:
		case 20103:

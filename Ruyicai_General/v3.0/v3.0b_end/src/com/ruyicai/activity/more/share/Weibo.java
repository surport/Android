 ...
 */
package com.ruyicai.activity.more.share;
...
//     public static String URL_OAUTH2_ACCESS_AUTHORIZE =  "http://t.weibo.com:8093/oauth2/authorize";
    ...
    /**/
    public Token getRequestToken(Context context, String key, String secret,
            String callback_url) {
        ...
        Token request = new Token(rlt);
        this.mRequestToken = request;
        return request;
    }

    public Token generateAccessToken(Context context, Token requestToken)
           {
        ...
        String rlt = Utility.openUrl(context, Weibo.URL_ACCESS_TOKEN, "POST", authParam,
                this.mRequestToken);
        Token accessToken = new Token(rlt);
        this.mAccessToken = accessToken;
        return accessToken;
    }

    public Token getXauthAccessToken(Context context, String app_key, String app_secret,

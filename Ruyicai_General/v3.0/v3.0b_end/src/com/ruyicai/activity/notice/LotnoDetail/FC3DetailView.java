...
public class FC3DetailView extends LotnoDetailView{
	...
	public void initLotonoView(JSONObject json) throws JSONException {
		...
		totalsellmoney.setText(context.getString(R.string.prizedetail_thebatchcodeamt)+json.getString("sellTotalAmount")+context.getString(R.string.game_card_yuan));

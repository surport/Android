...
//		phoneNumEdit.requestFocus();
	 ...
	 * 注册联网操作
	 */
	private void beginRegister(final String phoneNum,final String partPassword,final String cardId,final String name) {
		showDialog(PROGRESS_VALUE);
		Thread regthread = new Thread(new Runnable() {
			...
			public void run() {
				...
				String re = RegisterInterface.getInstance().userregister(phoneNum, partPassword, cardId, name);
				JSONObject obj;
				String error_code = "0";
				try {

...
//			clock.startThread();
	...
	private String[] titles = { "合买大厅","双色球","福彩3D","七乐彩","大乐透","排列三","排列五","七星彩","22选5","时时彩","江西11选5","11运夺金","专家荐号","广东11选5","足彩","竞足彩","竞篮彩"};
	private String iGameName[] = {"hmdt","ssq", "fc3d",    "qlc",      "cjdlt",   "pl3",     "pl5",     "qxc",     "22-5",  "ssc",     "11-5",           "11-ydj",     "zjjh",       "gd-11-5",    "zc",    "jcz",         "jcl"}; // 8.9

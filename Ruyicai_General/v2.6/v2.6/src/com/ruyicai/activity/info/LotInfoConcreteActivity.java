 ...
 @Override
  protected void onCreate(Bundle savedInstanceState) {
	...
	public void initTextView(){
		...
		switch(LotInfoActivity.newsinfotype){
		case 1:
			contentList = Constants.quwenInfoList.get(index).getContentList();
			break;
		case 2:
			contentList = Constants.zhuanjiaInfoList.get(index).getContentList();
			break;
		case 3:
			contentList = Constants.footballInfoList.get(index).getContentList();
			break;
		case 4:
			contentList = Constants.huodongInfoList.get(index).getContentList();
			break;
		}
				 ...
				 ThrowintoSpan span = new ThrowintoSpan(new OnClickListener() {
					...
					//	Log.v("do", "onclick");	
						...
						ok.setOnClickListener(new OnClickListener() {
							...
							public void onClick(View v) {
								// TODO Auto-generated method stub
								ShellRWSharesPreferences pre = new ShellRWSharesPreferences(LotInfoConcreteActivity.this, "addInfo");

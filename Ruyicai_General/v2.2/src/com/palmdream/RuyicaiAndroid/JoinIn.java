...
public class JoinIn extends Activity {
	...
	final Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case 12:
				...
				Intent intent2 = new Intent(JoinIn.this, UserLogin.class);
	...
	public void init() {
		...
		textrengou = (TextView) findViewById(R.id.buyLotteryMainList_join_title_two);
		textzongjine = (TextView) findViewById(R.id.join_in_text_money);
	}
	...
	public void update() {
		try {
			...
			if (lest == 0) {
				...
				editNum.setClickable(false);
				buttonBuy.setEnabled(false);
				editNum.setVisibility(View.GONE);
				buttonBuy.setVisibility(View.GONE);
				textrengou.setVisibility(View.GONE);
				textzongjine.setVisibility(View.GONE);
			}
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		...
		buttonBuy.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (sessionid.equals("")) {
					...
					Toast
							.makeText(JoinIn.this, "认购份数至少为一份！",
									Toast.LENGTH_SHORT).show();
					editNum.setText("");
				} else if (Integer.parseInt(num.trim()) > lested) {
					Toast.makeText(JoinIn.this, "认购份数大于剩余份数！",
							Toast.LENGTH_SHORT).show();
					editNum.setText("");
				} else {

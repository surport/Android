...
public class ChooseNumberDialogDLT extends Dialog implements OnClickListener,
	...
	public ChooseNumberDialogDLT(Context context, int aWhichDialog,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (iWhichLayout == 0) {
			...
			setSeekWhenAddOrSub(ssq_dantuo_blue_tuo_subtract, mSeekBarBlueTuo,
					-1, 3);
		...
		if (iWhichLayout == 0) {
			if (iProgressRed <= 5) {
				if (iProgressBlue == 2)
					...
					iDialogTip.setText(R.string.choose_number_dialog_tip3_dlt);
			} else {
				if (iProgressBlue == 2)
					iDialogTip.setText(R.string.choose_number_dialog_tip2_dlt);
				else
					iDialogTip.setText(R.string.choose_number_dialog_tip4_dlt);
			}
		} else {

 ...
 * 
 */
public class SscZhiXuan extends Activity implements OnClickListener, // 小球被点击
		// onClick
	...
	int topButtonIdOn[] = { R.drawable.wuxing_b, R.drawable.sanxing_b,
			R.drawable.erxing_b, R.drawable.yixing_b };
	int topButtonIdOff[] = { R.drawable.wuxing, R.drawable.sanxing,
			R.drawable.erxing, R.drawable.yixing };
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case RESULT_OK:
			...
			break;
		default:
			Toast.makeText(SscZhiXuan.this, "未登录成功！", Toast.LENGTH_SHORT).show();
			break;
		}
	}
}

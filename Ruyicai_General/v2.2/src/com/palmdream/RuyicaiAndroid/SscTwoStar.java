...
public class SscTwoStar extends Activity implements OnClickListener, // 小球被点击
	...
	int topButtonIdOn[] = { R.drawable.er_zuxuan_b, R.drawable.er_baodian_b };
	int topButtonIdOff[] = { R.drawable.er_zuxuan, R.drawable.er_baodian };
	...
	public void setCurrentTab(int index) {
		...
		case 0:
			...
			break;
		case 1:
			iCurrentButton = PublicConst.SSC_TWO_STAR_FEN_WEI;
			createView(iCurrentButton);
			break;
		case 2:
			iCurrentButton = PublicConst.SSC_TWO_STAR_BAO_DIAN;
			createView(iCurrentButton);
			break;
		case 3:
	...
	public void createView(int Type) {
		...
		case PublicConst.SSC_TWO_STAR_ZU_XUAN:
			...
			oneBallTable = makeBallTable(iV, R.id.ssc_table_ge, iScreenWidth,
					BallViewNum, BallViewWidth, BallResId, ONE_BALL_START, 0);
			break;
		case PublicConst.SSC_TWO_STAR_FEN_WEI:
			dialogType = PublicConst.SSC_TWO_STAR_FEN_WEI;
	...
	private void beginTouZhu() {
		...
		if (sessionIdStr.equals("")) {
			...
			if (jrtLot.ifPerfectIfo(this, sessionIdStr) && isTouzhu) {

...
public class ShengFC extends Activity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.shengfc);
		/** 顶部返回按钮 */
		...
		title.setText(getResources().getString(R.string.shengfucai));
		str = getLotno("information11");
		batchCode = str[0];
		// 获取数据
		getData();
	}
	...
	public void createVeiw() {
		...
		setSeekWhenAddOrSub(R.id.sfc_seekbar_subtract_beishu, null, -1,
				mSeekBarBeishu, true);
		setSeekWhenAddOrSub(R.id.sfc_seekbar_add_beishu, null, 1,
				mSeekBarBeishu, true);
	...
	public class ListViewDemo extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				convertView = mInflater.inflate(R.layout.shengfucai, null);
			...
			final BallTable shengfcRow = makeBallTable(
					(LinearLayout) convertView, R.id.shengfucai_ball,
					shengFCBallFieldWidth, ballNum, shengFCBallWidth, aResId,
					START_ID);

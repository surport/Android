...
import com.palmdream.RuyicaiAndroid.SscFiveStar;
import com.palmdream.RuyicaiAndroid.UserLogin;
import com.palmdream.RuyicaiAndroid.HomePage;
...
//	private static String baseUrl = "http://219.148.162.70:8000/jrtLot/"; // 服务器
	private static String messageUrl = "http://219.148.162.68/wirelessSupport/";
	public static String versionInfo = "2.2";// 当前版本号
	...
	public static String register(String mobile_code, String user_password,
		...
		String channel_id = HomePage.channel_id;// 掌上应用汇
	...
	public static String lotterySelect(String play_name) {
		...
		try {
			...
			PublicMethod.myOutput("-------------------url" + baseUrl + action
					+ ";jsessionid=" + "" + "?method=" + method
					+ "&jsonString=" + para + "&jsonWhere=" + para);
			// String re =
	...
	public static String startJoin(String mobile_code, String allamt,
		...
		try {
			...
			// para = URLEncoder.encode(para);
			// http.getViaHttpConnection(baseUrl+action+";jsessionid="+sessionid+"?method="+method+"&jsonString="+para);
			// Log.e("url===", baseUrl + action + ";jsessionid=" + sessionid
			// + "?method=" + method + "&" + jsonString + "=" + para);
			String re = http.getViaHttpConnection(baseUrl + action
					+ ";jsessionid=" + sessionid + "?method=" + method + "&"
					+ jsonString + "=" + para);
	 ...
	 * @return
	 */
	public static String getZCInfo(String lotno, String batchCode, String num) {
		String action = "zcAction.do";
	...
	public static String getMessage() {
		String action = "getClientMessage";
		...
		try {
			...
			//				
			String re = http
					.getViaHttpConnection_(messageUrl + method + action);
	 ...
	 * @版本：
	 */
	public static String isVersion(String type) {
		String action = "getUpdateInfo.action?";
		String method = "client!";
		String reValue = "";
		iHttp http = null;
		try {
			http = new iHttp();
			//				
			String re = http.getViaHttpConnection_(messageUrl + method + action
					+ "nameType=" + type);
	 ...
	 * @版本：
	 */
	public static void count(String type, String userid, String channelid,
			String username) {
		String action = "add.action?";
		String method = "userscale!";
		String reValue = "";
		iHttp http = null;
		...
		try {
			...
			if (type.equals("1")) {
				...
				re = http.getViaHttpConnection_(messageUrl + method + action
						+ "type=" + type + "&userid=" + userid + "&channelid="
						+ channelid);
				...
				re = http.getViaHttpConnection_(messageUrl + method + action
						+ "type=" + type + "&userid=" + userid + "&username="
						+ username);
			}
	 ...
	 * 登录客户端统计
	 */
	public static void addUserLogData(String channelid, String terminal,
			String sessionid, String phoneno) {
		String action = "userLog!add.action?";
		// String method = "client!";
		String reValue = "";
		iHttp http = null;
		try {
			...
			String re = http.getViaHttpConnection_(messageUrl + action
					+ "channelid=" + channelid + "&terminal=" + terminal
					+ "&sessionid=" + sessionid + "&phoneno=" + phoneno);
	 ...
	 * @版本：
	 */
	public static void uvNumber(String channelid, String version) {
		String action = "add.action?";
		String method = "uv!";
		iHttp http = null;
		try {
			http = new iHttp();
			http.getViaHttpConnection(messageUrl+method+action
					+"channelid="+channelid+"&client_version="+version
					+"&terminal=" +"C");
			Log.v("======UV", "''''uv");
	...
	public static void pvNumber(String type_now,String channelid, String sessionid,
		...
		try {
			...
			if(sessionid==null||username==null){
				http.getViaHttpConnection(messageUrl + method + action+"type_now="+type_now
						+ "&channelid=" + channelid+ "&terminal=" + "C" +"&client_version=" + version);
			}else
			http.getViaHttpConnection(messageUrl + method + action+"type_now="+type_now
					+ "&channelid=" + channelid+ "&terminal=" + "C" +"&sessionid="+sessionid+ "&username="+username+"&client_version=" + version
					);

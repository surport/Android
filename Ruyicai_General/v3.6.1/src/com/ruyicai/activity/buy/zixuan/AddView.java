...
public class AddView {
		...
		touzhu.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				if (codeList.size() > 0) {
					...
					Toast.makeText(context, context.getString(R.string.buy_add_dialog_toast_msg), Toast.LENGTH_SHORT)
							.show();
				}
			}
		});
			...
			for (int j = 0; j < codeList.get(i).getCodes().size(); j++) {
				...
				if (j != codeList.get(i).getCodes().size() - 1) {
					...
					zhuma.append(",");	
						...
						zhuma.append(",");
					} else if ((lotoNO.equals(Constants.LOTNO_11_5) && touzhuType.equals("dantuo"))
							|| (lotoNO.equals(Constants.LOTNO_ten) && touzhuType.equals("dantuo"))
							|| (lotoNO.equals(Constants.LOTNO_eleven) && touzhuType.equals("dantuo"))
							|| (lotoNO.equals(Constants.LOTNO_GD_11_5) && touzhuType.equals("dantuo"))) {
						zhuma.append("#");
					} else {
						zhuma.append("|");
					}
	...
	class AddListAdapter extends BaseAdapter {
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			codeInfo.setTextCodeColor(textCode, codeInfo.getLotoNo(), codeInfo.getTouZhuType());
	...
	public class CodeInfo {
		...
		public void setTextCodeColor(TextView textCode, String lotoNo, String touzhuType) {
			SpannableStringBuilder builder = new SpannableStringBuilder();
			int upLength = 0;
			for (int i = 0; i < getCodes().size(); i++) {
				String code = getCodes().get(i);
				builder.append(code);
				builder.setSpan(new ForegroundColorSpan(getColors().get(i)), upLength, code.length() + upLength,
		...
		private void addSeparator(String lotoNo, String touzhuType, SpannableStringBuilder builder, int i) {

			if (i != getCodes().size() - 1) {
				if(lotoNo==null||touzhuType==null){
					builder.append("|");
				}else  if ((lotoNo.equals(Constants.LOTNO_PL3) && ((touzhuType.equals("zu3_danshi")
						|| touzhuType.equals("zu3_fushi") || touzhuType.equals("zu3_hezhi")) || touzhuType
						.equals("zu6")))) {
					builder.append(",");
				} else if (lotoNo.equals(Constants.LOTNO_PL5) || lotoNo.equals(Constants.LOTNO_QXC)
				...
				} else if (lotoNo.equals(Constants.LOTNO_QLC) || lotoNo.equals(Constants.LOTNO_22_5)
						|| (lotoNo.equals(Constants.LOTNO_11_5) && touzhuType.equals("dantuo"))
						|| (lotoNo.equals(Constants.LOTNO_GD_11_5) && touzhuType.equals("dantuo"))
						|| (lotoNo.equals(Constants.LOTNO_ten) && touzhuType.equals("dantuo"))
						|| (lotoNo.equals(Constants.LOTNO_eleven) && touzhuType.equals("dantuo"))) {
					builder.append("#");

...
public class ZCDetailView extends LotnoDetailView{
	String title;
	public ZCDetailView(Activity context, String lotno, String batchcode,ProgressDialog progress,Handler handler,boolean isDialog) {
	...
	public void initLotonoView(JSONObject json) throws JSONException {
		...
		this.json=json;
		prizeBatchCode.setText(title+"  第"+json.getString("batchCode")+"期");
	...
	public String getShareString() {
		...
		try {
			str.append("#如意彩客户端#，").append(title+json.getString("batchCode")+"期,");

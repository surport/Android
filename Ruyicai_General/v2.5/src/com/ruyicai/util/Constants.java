...
//	public static String LOT_SERVER = "http://192.168.0.114:8000/lotserver/RuyicaiServlet";//金龙
	...
	public static String SOFTWARE_VERSION = "2.5.0.1";	
...
//	public static String COOP_ID = "232";//tompda
//	public static String COOP_ID = "683";//网秦王盟
//	public static String COOP_ID = "680";//网秦王盟
//	public static String COOP_ID = "681";//网秦王盟
//	public static String COOP_ID = "682";//网秦王盟
//	public static String COOP_ID = "684";//网秦王盟
//	public static String COOP_ID = "677";//oprea
//	public static String COOP_ID = "642";//baoruan
//	public static String COOP_ID = "676";//zhihuiyuan
//	public static String COOP_ID = "672";//报传媒
//	public static String COOP_ID = "560";//三星
//	public static String COOP_ID = "659";//公新市场
//	public static String COOP_ID = "658";//酷玩
	public static String COOP_ID = "661";//爱仕德
//	public static String COOP_ID = "232";//tompda

 ...
 * 
 */
public class GiftActivity extends Activity implements HandlerMsg ,OnSeekBarChangeListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		init();
//		setValue();
        allAtm=ZixuanActivity.addView.getAllAmt()*iProgressBeishu;
        zhumaStr=ZixuanActivity.addView.getsharezhuma();
        zhu=ZixuanActivity.addView.getAllZhu();
...
//		setValue();
	...
	public void getTouzhuAlert(){
		...
		jine.setText("金额："+iProgressQishu * ZixuanActivity.addView.getAllAmt() * iProgressBeishu
				+ "元");
		}
//		return "注数："

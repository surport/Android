...
public class Accoutmovecash extends Activity {
	...
	public View showView() {
		...
		view.findViewById(R.id.ruyihelper_listview_relative).setVisibility(View.GONE);
	...
	private static JSONObject getJSONByLotno(){
		JSONObject  jsonObjectByLotno =  RechargeDescribeInterface.getInstance().rechargeDescribe("bankTransferChargeDescription");

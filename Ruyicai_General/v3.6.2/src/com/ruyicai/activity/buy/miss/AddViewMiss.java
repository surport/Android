...
public class AddViewMiss {
	...
	public AddViewMiss(SimulateSelectNumberActivity simulateSelectNumberActivity) {
		this.context = simulateSelectNumberActivity;
	}
	...
	public AddViewMiss(TextView textNum, DanshiJiXuan jXActivity, boolean isZiXuan) {
	...
	public AddViewMiss(TextView textNum, ZixuanAndJiXuan zJActivity, boolean isZiXuan) {
		this.isZiXuan = isZiXuan;
		...
		private void addSeparator(String lotoNo, String touzhuType, SpannableStringBuilder builder, int i) {
			if (i != getCodes().size() - 1) {
				if (lotoNo == null || touzhuType == null) {
					builder.append("|");
				} else if (lotoNo.equals(Constants.LOTNO_SSQ) && touzhuType.equals("dantuo")) {
					if (i == 0) {
						builder.append("#");
					} else {
						builder.append("|");
					}
				} else if (lotoNo.equals(Constants.LOTNO_DLT) && touzhuType.equals("dantuo")) {
					if (i == 0 || i == 2) {
						builder.append("#");
					} else {
						builder.append("|");
					}
				} else if (lotoNo.equals(Constants.LOTNO_FC3D) && touzhuType.equals("zu3_danshi")) {
					builder.append(",");
				} else {
					builder.append("|");
				}

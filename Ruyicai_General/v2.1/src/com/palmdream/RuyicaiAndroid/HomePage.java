...
public class HomePage extends Activity {
	...
	// 保存软件当前版本信息的SharedPreference
	CheckVersionSharedPreference cvsp;
	String test_versionXmlUrl = "http://219.148.162.70:8000/w/wap/soft/ver/Version.xml";
	...
	public void checkCurrentVersion() {
		...
		cvsp = new CheckVersionSharedPreference(this, "Version");
		String versionInfo = cvsp.getPreferencesValue("version");
		String versionOnServer = ParseXML.parseVersionXml(test_versionXmlUrl);

		// 如果当前软件里的版本号比服务器上最新的版本号低的话，弹出Toast提醒用户下载最新版
		if (Double.parseDouble(versionInfo) < Double
				.parseDouble(versionOnServer)) {
			Toast.makeText(this, "官方网站提醒您请下载最新版本", Toast.LENGTH_LONG).show();
		}
	}

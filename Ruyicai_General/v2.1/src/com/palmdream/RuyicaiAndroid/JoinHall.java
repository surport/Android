...
public class JoinHall extends Activity implements
	...
	public void init() {
		...
		back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				finish();
				// Intent intent = new Intent(JoinHall.this,
		...
		// ImageButton menu;
		// login = (ImageButton) findViewById(R.id.join_hall_login);
		// menu = (ImageButton) findViewById(R.id.join_hall_menu);
		// if (BuyLotteryMainList.flag) {
		...
		// popList.showAtLocation(findViewById(R.id.join_hall_menu),
	...
	public class SuccessReceiver extends BroadcastReceiver {
		...
		public void showSuccessReceiver() {
			...
			Log.e("======", "success");
			// logn.setBackgroundResource(R.drawable.shouye_login_b);

...
public class AreaNum {
	...
	public AreaNum(int areaNum,int isNum, int areaMin,int chosenBallSum, int ballResId[],int startId, int startText, int textColor, String textView,boolean isJxBtn) {
		this.areaNum = areaNum;
		this.isNum = isNum;

...
public class NumViewItem extends BuyViewItem{
	...
	public View createView() {
		...
		for(int i=0;i<areaNums.length;i++){
			...
			areaNum .table =  PublicMethod.makeBallTable(areaNum .tableLayout, iScreenWidth, areaNum .areaNum,areaNum.ballResId,areaNum .aIdStart, areaNum .aBallViewText,false ,context,areaNum.isNum,null,null);
			areaNum .init();
		}	
		initBallOnclik();
		return view;

...
public class UserAgencyActivity extends Activity  implements OnClickListener{
	...
	private void agencyNet(final String userno,final String name,final String toName,final String amout,final String password) {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				// TODO Auto-generated method stub
				JSONObject jsonObjectByLotno = AgencyInterface.getInstance().agency(userno, name, toName, amout,password);
				try{

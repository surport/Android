...
public class TrackActivity extends JcScoreListActivity{
	...
	public void initList(){
		...
		List<ScoreInfo> listInfoCopy = new ArrayList<JcScoreListActivity.ScoreInfo>();
...
//	    	 textInfo.setVisibility(View.VISIBLE);
     ...
     * 获取列表联网
     */
    public void getScoreNet(final String type,final String date,final String reguestType) {

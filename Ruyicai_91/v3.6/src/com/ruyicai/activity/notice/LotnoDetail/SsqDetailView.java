 ...
 *
 */
public class SsqDetailView extends LotnoDetailView{

	public SsqDetailView(Activity context, String lotno, String batchcode,ProgressDialog progress,Handler handler,boolean isDialog) {
	...
	public void initLotonoView(JSONObject ssqPrizeDetailJson) throws JSONException {
		...
		prizeBatchCode.setText("双色球    第"+ssqPrizeDetailJson.getString("batchCode")+"期");
		...
		PrizeBallLinearLayout ssqBallLinear = new PrizeBallLinearLayout(context, ballLinear, "ssq", prizeNum);
		wincode=ssqBallLinear.initSSQBallLinear();
	...
	public String getShareString() {
		...
		try {
			str.append("#如意彩客户端#，").append("双色球第"+json.getString("batchCode")+"期,");

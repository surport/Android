...
public class JoinDingActivity extends Activity{
	 ...
	 * 初始化发起人信息
	 */
	private void initInfoView(String name,String crown,String cup,String diamond,String star,String lotno,String person){
		...
		PublicMethod.createStar(starLayout,crown,cup,diamond, star,this,0);
	...
	protected void setAmtText(){
		amtText.setText(""+Integer.parseInt(amtEdit.getText().toString())*Integer.parseInt(numEdit.getText().toString()));
	}
	/**
	 * 初始化百分比跟单
	 */
	private void initGroupTwoView(){
		...
		checkBox.setChecked(true);
		PublicMethod.setEditOnclick(percentEdit, 1, 100, new Handler());
	...
	private void jsonToStr(final String lotno,final JSONObject obj) {
		...
		try{
        	...
        	initInfoView(name, crown, cup, diamond, star, lotno, person);
        }catch(Exception e){

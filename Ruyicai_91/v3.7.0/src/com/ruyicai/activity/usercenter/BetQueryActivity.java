...
public class BetQueryActivity  extends Activity implements HandlerMsg{
	...
	private String [] allcountries={"全部彩种","双色球","福彩3D","江西11选5","广东11选5","广东快乐十分","大乐透","时时彩","七乐彩","排列三","竞彩足球","排列5","七星彩","11运夺金","竞彩篮球","22选5","足彩"};
	...
	final	String  BATCHCODE="batchCode",LOTMUTI="lotMulti",ORDERTIME="orderTime",PRIZEAMT = "prizeAmt" ,prizeState="prizeState",WINCODE="winCode"
		,BETCODE="betCode",LOTNO="lotNo",AMOUNT="amount",LOTNAME="lotName",PLAY="play",BET_CODE = "orderInfo";
...
//				queryinfolist.removeFooterView(view);
		...
		private LayoutInflater mInflater; // 扩充主列表布局
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				if(lotno.equals("J00001")||lotno.equals("J00002")||lotno.equals("J00003")||lotno.equals("J00004")||lotno.equals(Constants.LOTNO_JCLQ
						...
						||lotno.equals(Constants.LOTNO_JCLQ_SFC)||lotno.equals(Constants.LOTNO_JCZQ_HUN)||lotno.equals(Constants.LOTNO_JCLQ_HUN)){
					isJC = 1;
				}else{
					isJC = 0;
				}
				...
				holder.prizemoney.setText("未开奖");	
					...
					PublicMethod.setTextColor(holder.prizemoney, prizeStr, 5, prizeStr.length(), Color.RED);
				}
	...
	public void betQueryDetails(final BetQueryInfo betQueryinfo){
		...
		Thread t = new Thread(new Runnable() {
			String str = "00";
			public void run() {
				str = BetDetailsInterface.getInstance().betDetails(betQueryinfo.getOrderId());
				try {

...
public class RadioGroupView {
    ...
    public View createDanView(int teamNum){
    	...
    	if(danNum>LineNum){
    		...
    		for(int i=0;i<line;i++){
    		   addLine(layoutMain,i,LineNum,isDanNum,danTeamNum,checkTeam);
    		}
    		if(num!=0){
     ...
     * @param lineNum
     */
	private void addLine(LinearLayout layoutMain, int line,int lineNum,int isDanNum,int danTeamNum, int teamNum) {
		LinearLayout layoutOne = new LinearLayout(context);
		int id =0;

...
public class AreaInfo {
	 ...
	 * 选区信息类
	 * @param areaNum       选区小球数
	 * @param chosenBallSum 可选小球数
	 * @param ballResId     选区小球的类型id，例如，{ R.drawable.grey, R.drawable.red }
	 * @param startId       小球起始id  一般为“0”
	 * @param startText     小球其实数字 一般为”1“
	 * @param textColor  小球颜色
	 * @param textView  选区标示，例"蓝球区:"
	 */

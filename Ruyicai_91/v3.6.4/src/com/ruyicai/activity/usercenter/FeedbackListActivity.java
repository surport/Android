...
public class FeedbackListActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initBtn();	
		if(!getIntent().getStringExtra("notReadLetterCount").equals("")){
		notReadLetterCount=Integer.valueOf(getIntent().getStringExtra("notReadLetterCount"));
		}
...
//				initLinear(scroedetail, linearId[0], view);
	...
	public void addTab(int index){
		...
		if(index==1&&notReadLetterCount>0){

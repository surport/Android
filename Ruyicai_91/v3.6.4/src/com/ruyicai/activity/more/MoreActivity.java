...
//	private CompanyInfo  companyInfo = new CompanyInfo(this);//公司简介
    ...
    RelativeLayout kaijiangdingyue,personidset,weibobangding,caizhongSetting,goucaitixingSetting;//设置界面 开奖订阅和个人帐号设置//彩种设置
...
//		renren = new Renren(this);
	...
	OnClickListener moreActivityListener = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.tableRow_goucaitixing:
				Intent intentAlarmSet = new Intent(MoreActivity.this,LotnoAlarmSetActivity.class);
			...
			case R.id.auto_login_set_checkbox_jixuan:
				boolean isJixuan = shellRW.getBooleanValue(ShellRWConstants.ISJIXUAN);
				if(isJixuan == false){
			...
			case R.id.isSharetoRenren:
		    	...
		    	String	tencent_access_token_secret=shellRW.getStringValue("tencent_access_token_secret");
	...
	public void tenoauth(){
		...
		if(tencent_token.equals("")&&tencent_access_token_secret.equals("")){
		   ...
		   Intent  intent = new Intent(MoreActivity.this, OAuthV1AuthorizeWebView.class);//创建Intent，使用WebView让用户授权
		   ...
		   startActivityForResult(intent,1);	
			...
			Intent intent=new Intent(MoreActivity.this, TencentShareActivity.class);
...
//			switchView(systemSet.showView());
	...
	private  void  initAutoJixuanSet(){
		  boolean  is_auto_login = shellRW.getBooleanValue(ShellRWConstants.ISJIXUAN,true);
        	  if(is_auto_login){
        		  auto_jixuan_set.setBackgroundResource(R.drawable.on);
        	  }else{
        		  auto_jixuan_set.setBackgroundResource(R.drawable.off);

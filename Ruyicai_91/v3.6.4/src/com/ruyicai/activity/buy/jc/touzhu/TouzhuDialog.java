...
public class TouzhuDialog {
	...
	public void alert() {
		...
		prizeText = (TextView)v.findViewById(R.id.alert_dialog_touzhu_prizescope);//竞彩中奖金额范围
	...
	private void beginTouzhu() {
		initBet();
		ApplicationAddview app = (ApplicationAddview) context.getApplicationContext();
    ...
    public String getFreedomGuoGuanPrize(int muti){
    	...
    	result.append("预计中奖金额：").append(PublicMethod.formatStringToTwoPoint(mix)).append("元~").append(PublicMethod.formatStringToTwoPoint(max)).append("元 ");
    	return result+"";
    }

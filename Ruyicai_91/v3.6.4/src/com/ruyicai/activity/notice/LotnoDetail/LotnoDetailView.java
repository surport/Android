...
//		Toast.makeText(JoinDetailActivity.this, "网易分享", Toast.LENGTH_SHORT).show();	
				MobclickAgent.onEvent(context,"renren" );//BY贺思明 最新开奖页点击“分享至人人网”。
				tenoauth();
			}
		});
...
//				Toast.makeText(JoinDetailActivity.this, "新浪分享", Toast.LENGTH_SHORT).show();		
				MobclickAgent.onEvent(context,"xinlang" );//BY贺思明 最新开奖页点击“分享至新浪微博”。
				oauthOrShare();
	...
	fenxianglayout.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			if(issharemove){
				MobclickAgent.onEvent(context,"fenxiang" );//BY贺思明 最新开奖页点击“分享”展开按钮。

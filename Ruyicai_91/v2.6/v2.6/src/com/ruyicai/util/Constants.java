...
//	public static String LOT_SERVER = "http://192.168.0.114:8000/lotserver/RuyicaiServlet";//金龙
	...
	public static String SOFTWARE_VERSION = "2.6.0.1";	
...
//	public static String COOP_ID = "548";//91谢成千
//	public static String COOP_ID = "547";//91何文谨
	public static String COOP_ID = "545";//91徐婷
//	public static String COOP_ID = "569";//91rom
//	public static String COOP_ID = "536";//91zhushou

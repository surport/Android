...
public class NoticeActivityGroup extends BuyActivityGroup{
	...
	private void initView(int listViewID) {
		...
		case NoticeActivityGroup.ID_SUB_PL5_LISTVIEW:
			Log.e("@pl5","pl51111");
			String[] topTitlespl5 ={"排列五开奖公告","排列五开奖公告"};
			String[] titlespl5 ={"开奖走势","开奖号码"};
			Class[] allIdpl5 ={NoticeRedBallActivity.class,NoticeInfoActivity.class};
			init(titlespl5, topTitlespl5, allIdpl5);
			break;
		case NoticeActivityGroup.ID_SUB_QXC_LISTVIEW:
			Log.e("@qxc","qxc1111");
			String[] topTitlesqxc ={"七星彩开奖公告","七星彩开奖公告"};
			String[] titlesqxc ={"开奖走势","开奖号码"};
			Class[] allIdqxc ={NoticeRedBallActivity.class,NoticeInfoActivity.class};

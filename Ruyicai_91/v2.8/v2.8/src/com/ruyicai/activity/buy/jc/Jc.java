...
//	public static List<ArrayList> infos = new ArrayList<ArrayList>();
	...
	public void jcInfoNet() {
		...
		Thread t = new Thread(new Runnable() {
			...
			@Override
			public void run() {
				str = QueryJcInfoInterface.getInstance().queryJcInfo();
				try {
...
//		String[] topTitles = new String[length];
//		Class[] allId = new Class[length];
//		for (int i = 0; i < length; i++) {
//			titles[i] = "过关投注";
//			topTitles[i] = "竞彩足球-过关投注";
//			allId[i] = JcGuoGuan.class;
//		}
		removeTabs();
		String[] titles = {"过关投注"};

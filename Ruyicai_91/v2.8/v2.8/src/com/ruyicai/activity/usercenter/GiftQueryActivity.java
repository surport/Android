	               ...
	               if(pageindexgifted<1){
	            	   pageindexgifted = 1;
	   				   Toast.makeText(GiftQueryActivity.this, R.string.usercenter_hasgonefirst, Toast.LENGTH_SHORT).show();   
	            	   	...
	            	   	List list = initAdapterlist(pageindexgifted,gifteddatalist,1);
		        		initListView(list);
	               }
				 ...
				 pageindex--;
	               if(pageindex<1){
	   				...
	   				Toast.makeText(GiftQueryActivity.this, R.string.usercenter_hasgonefirst, Toast.LENGTH_SHORT).show();   
	            		...
	            		List list = initAdapterlist(pageindex,giftdatalist,0);
		        		initListView(list);
	               }
	...
	public class GiftQueryAdapter extends BaseAdapter {
		...
		private LayoutInflater mInflater; // 扩充主列表布局
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				final  int   isgift  = (Integer)mList.get(position).get(ISGIFT);
				final String lotteryname = (String) mList.get(position).get(LOTNO);

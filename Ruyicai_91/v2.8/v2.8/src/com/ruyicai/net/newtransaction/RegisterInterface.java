...
public class RegisterInterface {
	...
	public String userregister(String login_User, String login_password, String login_Id,String realname,String isBindPhone,String recommand_phonenum) {

		JSONObject obj = null;
			//String re = register(login_User, login_password, login_Id);
			
			String re = registerLotserver(login_User, login_password, login_Id, realname,isBindPhone,recommand_phonenum);
	...
	public String registerLotserver(String mobileCode,String password,String certid,String realname,String isBindPhone,String recommand_phonenum){
		...
		try {
			...
			jsonProtocol.put(ProtocolManager.RECOMMANDER, recommand_phonenum);

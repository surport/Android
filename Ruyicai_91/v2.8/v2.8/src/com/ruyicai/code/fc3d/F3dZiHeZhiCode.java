...
import com.ruyicai.activity.buy.fc3d.Fc3dZiHeZhi;
...
public class F3dZiHeZhiCode extends CodeInterface {
	...
	public String zhuma(AreaNum[] areaNums, int beishu,int type) {
		...
		if (Fc3dZiHeZhi.iCurrentButton == PublicConst.BUY_FC3D_HEZHI_ZHIXUAN) {
			typeCode = zxHHH;
		...
		} else if (Fc3dZiHeZhi.iCurrentButton == PublicConst.BUY_FC3D_HEZHI_ZU3) {
			typeCode = z3HHH;
		...
		} else if (Fc3dZiHeZhi.iCurrentButton == PublicConst.BUY_FC3D_HEZHI_ZU6) {
			typeCode = z6HHH;

...
public class UserInfo {
    ...
    /**
     * 是否为星级用户，校内中1表示是；表示不是,表示非真实姓名和头像表示非真实姓名，2表示非真实头像，3表示真实用户
     */
    private int star;
    ...
    /**
     * 出生时间，格式为：yyyy-mm-dd，需要自行格式化日期显示格式。注：年0后，实际返回1760-mm-dd0后，返回1770-
     * mm-dd0后，返回1780-mm-dd0后，返回1790-mm-dd
     */

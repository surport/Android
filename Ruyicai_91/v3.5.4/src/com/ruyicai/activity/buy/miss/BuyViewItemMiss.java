...
public class BuyViewItemMiss extends GalleryViewItem{
	...
	public View createView() {
		...
		int btnIds[]={R.id.buy_zixuan_btn_one,R.id.buy_zixuan_btn_two,R.id.buy_zixuan_btn_third,R.id.buy_zixuan_btn_four,R.id.buy_zixuan_btn_five,R.id.buy_zixuan_btn_six,R.id.buy_zixuan_btn_seven};
		int btnDwIds[]={R.id.buy_zixuan_btn_num_one,R.id.buy_zixuan_btn_num_two,R.id.buy_zixuan_btn_num_third,R.id.buy_zixuan_btn_num_four,R.id.buy_zixuan_btn_num_five,R.id.buy_zixuan_btn_num_six,R.id.buy_zixuan_btn_num_seven};
		if(isRight){
			rightBtn(view);
		}
		height = 0;
		...
		for(int i=0;i<areaNums.length;i++){
			...
			if(areaNum.isJxBtn){
				...
				areaNum.jixuanBtn = new JiXuanBtn(areaNum.isRed, btn,btnDw, areaNum.chosenBallSum,zixuan,view,areaNum .table,areaNum.areaMin,i);
			}else{

...
public class RuyiExpressFeelSuccess extends Activity {
	...
	Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case 2:
				progressDialog.dismiss();
				Toast.makeText(getBaseContext(), "扣款失败！", Toast.LENGTH_LONG).show();
				break;
			case 3:
				progressDialog.dismiss();
			...
			case 5:
				progressDialog.dismiss();
				Toast.makeText(getBaseContext(), "赠送失败！", Toast.LENGTH_LONG).show();
				break;
			case 6:
				progressDialog.dismiss();
				Toast.makeText(getBaseContext(), "该期已结！", Toast.LENGTH_LONG).show();
				break;
			case 7:
				progressDialog.dismiss();
				...
				Toast.makeText(getBaseContext(), "赠送请求已受理！", Toast.LENGTH_LONG).show();
				break;
			case 8:
				progressDialog.dismiss();
				Toast.makeText(getBaseContext(), "正在赠送中！", Toast.LENGTH_LONG).show();
				break;
			}
			//				
		}

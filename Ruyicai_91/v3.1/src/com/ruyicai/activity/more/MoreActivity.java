...
//				break;
	...
	private void oauth(){
		String CONSUMER_KEY = "2806185439";// 替换为开发者的appkey，例如"1646212960";
		String CONSUMER_SECRET = "f9acd48bfcb796da21f55015a2752ede";// 替换为开发者的appkey，例
		Weibo weibo = Weibo.getInstance();
		weibo.setupConsumerConfig(CONSUMER_KEY, CONSUMER_SECRET);
		// Oauth2.0
		// 隐式授权认证方式
		weibo.setRedirectUrl("http://soft.sj.91.com/91lottery/index.shtml");// 此处回调页内容应该替换为与appkey对应的应用回调页

	...
	public class WinPrizeAdapter extends BaseAdapter {
		...
		private LayoutInflater mInflater; // 扩充主列表布局
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				holder.prizemoney.setText(prizeString+prizemoney);
				...
				holder.lookdetail.setOnClickListener(new OnClickListener() {
					public void onClick(View v) {
						...
						detailinfo.append(getString(R.string.usercenter_lotterytypename)).append(lotName).append("\n\n")
							...
							.append(getString(R.string.usercenter_bettingTime)).append(sellTime).append("\n\n")
							.append(getString(R.string.usercenter_endTime)).append(cashtime).append("\n\n")
							.append(getString(R.string.usercenter_prizeMoney)).append(prizemoney).append("\n\n")

...
public class NewUserCenter extends Activity{
	...
	protected	String phonenum,sessionid,userno;
   ...
   OnItemClickListener clickListener = new OnItemClickListener() {
	...
	protected List<Map<String, Object>> getListForAccountAdapter() {
		String[] titles = {this.getString(R.string.usercenter_accountDetails),
				...
				this.getString(R.string.usercenter_passwordChange) };
		int[] accountDetailInfoIcons = {R.drawable.usercenter_ico_accountdetail,R.drawable.usercenter_ico_withdraw,R.drawable.usercenter_ico_changpw};
		List<Map<String, Object>> list = new ArrayList<Map<String, Object>>(2);
   ...
   private void userCenterDetail() {
	...
	protected void onStart() {
		super.onStart();
	//	Log.v("======NewUserCenter==========","start");
	}
	@Override
	protected void onResume() {
		super.onResume();
	//	Log.v("=======NewUserCenter================","onResume");
	}
	@Override
	protected void onStop() {
		super.onStop();
	//	Log.v("=======NewUserCenter================","onStop");
	}
	@Override
	protected void onRestart() {
		super.onRestart();
	//	Log.v("=======NewUserCenter================","onRestart");
	}
	@Override
	protected void onPause() {
		super.onPause();
	//	Log.v("=======NewUserCenter================","onPause");
	}
	@Override
	protected void onDestroy() {
		super.onDestroy();
	//	Log.v("=======NewUserCenter================","onDestroy");
	}

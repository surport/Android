...
//			@Override
//			public void onClick(View v) {
//				String str = Controller.getInstance(context).alipaySignNet();
//			}
//		});
		// 点击注册按钮时，跳转到注册页面
...
//					} else if (!isCardId(cardId)) { //close by yejc 20130424
	...
	public class AliPay implements IAlixPay {
		...
		@Override
		public String Pay(String arg0) throws RemoteException {
			return null;
		}

		@Override
		public void registerCallback(IRemoteServiceCallback arg0)
		...
		@Override
		public void unregisterCallback(IRemoteServiceCallback arg0)
				throws RemoteException {
		}

...
//		   initZhuiJia(view);
	...
	public AreaNum[] initDltNormalArea(){
        ...
        areaNums[0] = new AreaNum(35,8, 4, redBallResId, 0, 1,Color.RED,redTitle);
        areaNums[1] = new AreaNum(35,8, 18, redBallResId, 0, 1,Color.RED,redtuoTitle);
        areaNums[2] = new AreaNum(12,8, 1, blueBallResId, 0, 1,Color.BLUE,blueTitle);
        areaNums[3] = new AreaNum(12,8, 12, blueBallResId, 0, 1,Color.BLUE,bluetuoTitle);
        return areaNums;
	}

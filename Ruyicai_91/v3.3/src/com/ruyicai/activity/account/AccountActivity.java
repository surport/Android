...
public class AccountActivity extends Activity  implements HandlerMsg {
	...
	public void setTopText(){
		...
		Spanned spanned = Html.fromHtml("<a href=\"http://91.ruyicai.com\">"+text2+"</a>");
...
// 			Log.e(textString, textString);
	...
	private void onClickList() {
		...
		}else if ((getString(R.string.zhfb_cards_secure_recharge)+"(免手续费)").equals(textString)){
			  createAlipaySecureDialog();
		} else if ((getString(R.string.bank_cards_recharge)+"(免手续费)").equals(textString)) {
			  checkDNA();
		} else if ("银联充值(免手续费)".equals(textString)) {

...
public abstract class BaseDialog {
	...
	public View createDirectPayView() {
		...
		ok.setText(activity.getResources().getString(R.string.directpay_dialog_todirectpay));
		cancel.setText(activity.getResources().getString(R.string.directpay_dialog_torecharge));

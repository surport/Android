...
public class JoinInfoActivity extends Activity implements HandlerMsg {
	...
	private void netting(final String orderBy, final String orderDi) {
		String str = "00";
		str = QueryJoinInfoInterface.queryLotJoinInfo(lotno, issue, orderBy, orderDir, ""
				+ viewInfos[topIndex][lottypeIndex].newPage, JoinHallActivity.PAGENUM);
	...
	public class JoinInfoAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (with == 800) {
				LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(PublicMethod.getPxInt(110,
						JoinInfoActivity.this), PublicMethod.getPxInt(28, JoinInfoActivity.this));
				holder.type.setLayoutParams(params);
				LinearLayout.LayoutParams paramsLayout = new LinearLayout.LayoutParams(250,LayoutParams.WRAP_CONTENT);
			...
			PublicMethod.createStar(holder.starNum, info.getCrown(), info.getGrayCrown(), info.getCup(),
					info.getGrayCup(), info.getDiamond(), info.getGrayDiamond(), info.getStarNum(),
					info.getGrayStarNum(), JoinInfoActivity.this, 4);
			return convertView;
		}
	...
	AlertDialog selecetDialog() {
		...
		return new AlertDialog.Builder(JoinInfoActivity.this).setTitle("筛选彩种")

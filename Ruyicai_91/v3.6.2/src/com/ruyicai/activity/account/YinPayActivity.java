...
public class YinPayActivity extends Activity  implements HandlerMsg{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		secureOk.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				MobclickAgent.onEvent(YinPayActivity.this, "chongzhi ");//BY贺思明 2012-6-29
	...
	private static JSONObject getJSONByLotno(){
		JSONObject  jsonObjectByLotno =  RechargeDescribeInterface.getInstance().rechargeDescribe("lthjChargeDescription");
    ...
    private void beginYinpayRecharge(View Vi) {
		...
		RWSharedPreferences pre = new RWSharedPreferences(YinPayActivity.this, "addInfo");
		String sessionIdStr = pre.getStringValue("sessionid");
		if (sessionIdStr.equals("")) {
			Intent intentSession = new Intent(YinPayActivity.this,UserLogin.class);

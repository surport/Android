...
public class QLC extends Activity // 事件 回调函数
	...
	private int redTuoBallResId[] = { R.drawable.grey, R.drawable.blue };

	// Vector<OneBallView> blueBallViewVector;
	BallTable blueBallTable = null;
	private int blueBallResId[] = { R.drawable.grey, R.drawable.red };
	...
	Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case 11:
				...
				Intent intent2 = new Intent(QLC.this, UserLogin.class);

...
public class ChooseNumberDialogSSQ extends Dialog implements OnClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (iWhichLayout == 0) {
			...
			// ssq_dantuo_red_add.setOnClickListener(new
			...
			//				
			// });
			// ssq_dantuo_red_subtract.setOnClickListener(new
			// ImageButton.OnClickListener(){
			//
			// @Override
			// public void onClick(View v) {
			...
			//				
			// });
			// ssq_dantuo_red_tuo_add.setOnClickListener(new
			// ImageButton.OnClickListener(){
			//
			// @Override
			// public void onClick(View v) {
			// mSeekBarRedTuo.setProgress(++iProgressRed);
			// }
			//				
			// });
			// ssq_dantuo_red_tuo_subtract.setOnClickListener(new
			// ImageButton.OnClickListener(){
			//
			// @Override
			// public void onClick(View v) {
			...
			//				
			// });
			// ImageButton ssq_dantuo_blue_subtract =
			// (ImageButton)findViewById(R.id.ssq_dantuo_dialog_blue_subtract);
			// ImageButton ssq_dantuo_blue_add =
			// (ImageButton)findViewById(R.id.ssq_dantuo_dialog_blue_add);
			// ssq_dantuo_blue_add.setOnClickListener(new
			// ImageButton.OnClickListener(){
			//
			// @Override
			// public void onClick(View v) {
			// mSeekBarBlue.setProgress(++iProgressRed);
			// }
			//				
			// });
			// ssq_dantuo_blue_subtract.setOnClickListener(new
			// ImageButton.OnClickListener(){
			//
			// @Override
			// public void onClick(View v) {

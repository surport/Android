...
public class RegisterInterface {
	...
	public String userregister(String login_User, String login_password, String login_Id,String realname,String referrer) {

		JSONObject obj = null;
			//String re = register(login_User, login_password, login_Id);
			
			String re = registerLotserver(login_User, login_password, login_Id, realname,referrer);
	...
	public String registerLotserver(String mobileCode,String password,String certid,String realname,String referrer){

...
//		   mGallery.setAreaWith(100);
	...
	public AreaNum[] initArea(){
	  ...
	  areaNums[0] = new AreaNum(33,8, 1,5, redBallResId , 0, 1,Color.RED,danma,true,false);		
	  areaNums[1] = new AreaNum(33,8, 2,16, redBallResId , 0, 1,Color.RED,tuoma,true,false);	
	  areaNums[2] = new AreaNum(16,8, 1,16, blueBallResId , 0, 1,Color.BLUE,blue,true,false);	
	  return areaNums;
	}
	/**
	 * 根据小球id判断是哪个选区

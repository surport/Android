...
public class ChangJWT extends Activity {
	...
	public final static int ID_WENTI18 = 18;
	public final static int ID_WENTI19 = 19;
	...
	private String[] titles = { "使用如意彩购彩都有哪些优势？", "使用客户端购买彩票安全吗？",
			"登录时忘记密码了怎么办？", "为什么要填写真实姓名和身份证号？", "充值未及时到账怎么办？", "银联在线支付支持那些银行？",
			"如何更换绑定的手机号？", "提现后多久能到账？", "如何查看方案中奖详情？", "各彩种的开奖时间是什么时候？",
			"什么是昵称？", "可以在如意彩注册多个账户吗？", "如何修改登陆密码？", "身份证号不小心填错了怎么办？",
			"如何保护账户的资金安全？", "合买都有哪些规则？", "合买方案中奖后奖金如何分配？", "合买方案如何置顶？",
			"怎样撤销合买方案？" };
	Activity activity;
	...
	public View showView() {
		...
		OnItemClickListener clickListener = new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				} else if (titles[17].equals(str)) {
					setContentView(showInfoView(ID_WENTI18));
				} else if (titles[18].equals(str)) {
					setContentView(showInfoView(ID_WENTI19));
				}
	...
	protected View showInfoView(int aInfoFlag) {
		...
		case ID_WENTI17:
			...
			break;
		case ID_WENTI18:
			iFileName = "ruyihelper_WENTI17.html";
			title.setText("常见问题");
			break;
		case ID_WENTI19:
			iFileName = "ruyihelper_WENTI18.html";
			title.setText("常见问题");
			break;
		}

    ...
    OnClickListener click=new OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.share:
                 ...
                 try {
                     response=tAPI.add(oAuthV1, "json", tencentsharecontent, "127.0.0.1");
                     ...
                     if(errorcode.equals("0")){
                    	    runOnUiThread(new Runnable() {
                    			...
                    			@Override
                                public void run() {
                                	RWSharedPreferences  pre = new RWSharedPreferences(TencentShareActivity.this, "addInfo");
                                    userno = pre.getStringValue("userno");
                                    Toast.makeText(TencentShareActivity.this, R.string.send_sucess, Toast.LENGTH_LONG).show();
                         		    Addscorewithshare.getInstance().addscore(userno, "资讯分享",Constants.source);//添加积分
                                }
                            });
                    	 ...
                    	 runOnUiThread(new Runnable() {
                 			...
                 			@Override
                             public void run() {
                                 Toast.makeText(TencentShareActivity.this, msg, Toast.LENGTH_LONG).show();
                             }
                         });
                 	    TencentShareActivity.this.finish();
                     }

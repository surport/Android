...
public class NoticeJclActivity extends Activity implements HandlerMsg{
	...
	public class JcInfoAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			holder.homeText = (TextView) convertView.findViewById(R.id.jc_main_list_item_text_team_home);
			holder.guestText = (TextView) convertView.findViewById(R.id.jc_main_list_item_text_team_guest);
	...
	private void formatDate(String dateStr){
  	...
  	private void  showBatchcodesDialog(){
		AlertDialog batchCodedialog =  new AlertDialog.Builder(NoticeJclActivity.this)

...
//		renren = new Renren(this);
	...
	public void tenoauth(){
		...
		if(tencent_token.equals("")&&tencent_access_token_secret.equals("")){
		   ...
		   Intent  intent = new Intent(JoinStarShare.this, OAuthV1AuthorizeWebView.class);//创建Intent，使用WebView让用户授权
		   ...
		   startActivityForResult(intent,1);	
			...
			Intent intent=new Intent(JoinStarShare.this, TencentShareActivity.class);

...
public class JcLqScoreInfoActivity extends Activity{
	...
	private void isSession(JSONObject json){
		try {
			...
			if(session.equals("4")&&isOver){
				create4View(json.getString("homeTeam"),json.getString("guestTeam"),json.getString("homeOne"),json.getString("guestOne"),json.getString("homeTwo")
						   ,json.getString("guestTwo"),json.getString("homeThree"),json.getString("guestThree"),json.getString("homeFour"),json.getString("guestFour"));
			}else if(session.equals("2")&&isOver){
				create2View(json.getString("homeTeam"),json.getString("guestTeam"),json.getString("homeOne"),json.getString("guestOne"),json.getString("homeThree"),json.getString("guestThree"));
			}
		} catch (JSONException e) {
			e.printStackTrace();
		}
	 ...
	 * 创建4节比赛界面
	 */
	public void create4View(String hName,String vName,String homeOne,String guestOne,String homeTwo,
			                String guestTwo,String homeThree,String guestThree,String homeFour,String guestFour){
		...
		TextView vTeamText = (TextView) viewItem.findViewById(R.id.jc_lq_score_text_vteam);
		TextView hTeamText = (TextView) viewItem.findViewById(R.id.jc_lq_score_text_hteam);
		TextView v1TeamText = (TextView) viewItem.findViewById(R.id.jc_lq_score_text_v1);
		TextView v2TeamText = (TextView) viewItem.findViewById(R.id.jc_lq_score_text_v2);
		TextView v3TeamText = (TextView) viewItem.findViewById(R.id.jc_lq_score_text_v3);
		TextView v4TeamText = (TextView) viewItem.findViewById(R.id.jc_lq_score_text_v4);
		TextView h1TeamText = (TextView) viewItem.findViewById(R.id.jc_lq_score_text_h1);
		TextView h2TeamText = (TextView) viewItem.findViewById(R.id.jc_lq_score_text_h2);
		TextView h3TeamText = (TextView) viewItem.findViewById(R.id.jc_lq_score_text_h3);
		TextView h4TeamText = (TextView) viewItem.findViewById(R.id.jc_lq_score_text_h4);
	 ...
	 * 创建2节比赛界面
	 */
	public void create2View(String hName,String vName,String homeOne,String guestOne,String homeTwo,String guestTwo){
		LinearLayout layoutMain = (LinearLayout) findViewById(R.id.main_score_layout_bottom);
		LayoutInflater inflate = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);

...
public class LotnoAlarmSetActivity extends Activity implements OnClickListener, OnCheckedChangeListener {
	...
	private void updateAlarmTimeTextView() {
		int hour   = lotnoAlarmManager.getAlarmTimeSetting(LotnoAlarmManager.PREFERENCE_HOUR_KEY);
		int minute = lotnoAlarmManager.getAlarmTimeSetting(LotnoAlarmManager.PREFERENCE_MINUTE_KEY);

		alarmTimeTextView.setText(new StringBuilder().append(fromatNumberToDoublePlace(hour)).append(":").append(fromatNumberToDoublePlace(minute)));
	}
	...
	private void updateLotnoToggleButton() {
		openVoiceToggleButton .setChecked(lotnoAlarmManager.getLotnoSetting(LotnoAlarmManager.PREFERENCE_OPENVOICE_KEY));
		ssqToggleButton       .setChecked(lotnoAlarmManager.getLotnoSetting(LotnoAlarmManager.PREFERENCE_SSQ_KEY));
		dltToggleButton       .setChecked(lotnoAlarmManager.getLotnoSetting(LotnoAlarmManager.PREFERENCE_DLT_KEY));
		fc3dToggleButton      .setChecked(lotnoAlarmManager.getLotnoSetting(LotnoAlarmManager.PREFERENCE_FC3D_KEY));
		qlcToggleButton       .setChecked(lotnoAlarmManager.getLotnoSetting(LotnoAlarmManager.PREFERENCE_QLC_KEY));
		qxcToggleButton       .setChecked(lotnoAlarmManager.getLotnoSetting(LotnoAlarmManager.PREFERENCE_QXC_KEY));
		pl3ToggleButton       .setChecked(lotnoAlarmManager.getLotnoSetting(LotnoAlarmManager.PREFERENCE_PL3_KEY));
		pl5ToggleButton       .setChecked(lotnoAlarmManager.getLotnoSetting(LotnoAlarmManager.PREFERENCE_PL5_KEY));
		tewntyfiveToggleButton.setChecked(lotnoAlarmManager.getLotnoSetting(LotnoAlarmManager.PREFERENCE_TWENTYFIVE_KEY));
	}
	...
	protected Dialog onCreateDialog(int id) {
		...
		case ALARMTIME_TIMEDIALOG_ID:
			dialog = new TimePickerDialog(this, timeSetListener,
					lotnoAlarmManager.getAlarmTimeSetting(LotnoAlarmManager.PREFERENCE_HOUR_KEY),
					lotnoAlarmManager.getAlarmTimeSetting(LotnoAlarmManager.PREFERENCE_MINUTE_KEY), false);
			break;
		}
	...
	private TimePickerDialog.OnTimeSetListener timeSetListener = new TimePickerDialog.OnTimeSetListener() {
		...
		public void onTimeSet(TimePicker view, int hourOfDay, int minuteOfHour) {
			lotnoAlarmManager.setAlarmTimeSetting(LotnoAlarmManager.PREFERENCE_HOUR_KEY, hourOfDay);
			lotnoAlarmManager.setAlarmTimeSetting(LotnoAlarmManager.PREFERENCE_MINUTE_KEY, minuteOfHour);
			updateAlarmTimeTextView();
		}
	};
	...
	public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
		...
		case OPENVOICE_TOGGLEBUTTON_ID:
			lotnoAlarmManager.setLotnoSetting(LotnoAlarmManager.PREFERENCE_OPENVOICE_KEY,  isChecked);
			break;
		case SSQ_TOGGLEBUTTON_ID:
			lotnoAlarmManager.setLotnoSetting(LotnoAlarmManager.PREFERENCE_SSQ_KEY,        isChecked);
			break;
		case DLT_TOGGLEBUTTON_ID:
			lotnoAlarmManager.setLotnoSetting(LotnoAlarmManager.PREFERENCE_DLT_KEY,        isChecked);
			break;
		case FC3D_TOGGLEBUTTON_ID:
			lotnoAlarmManager.setLotnoSetting(LotnoAlarmManager.PREFERENCE_FC3D_KEY,       isChecked);
			break;
		case QLC_TOGGLEBUTTON_ID:
			lotnoAlarmManager.setLotnoSetting(LotnoAlarmManager.PREFERENCE_QLC_KEY,        isChecked);
			break;
		case QXC_TOGGLEBUTTON_ID:
			lotnoAlarmManager.setLotnoSetting(LotnoAlarmManager.PREFERENCE_QXC_KEY,        isChecked);
			break;
		case PL3_TOGGLEBUTTON_ID:
			lotnoAlarmManager.setLotnoSetting(LotnoAlarmManager.PREFERENCE_PL3_KEY,        isChecked);
			break;
		case PL5_TOGGLEBUTTON_ID:
			lotnoAlarmManager.setLotnoSetting(LotnoAlarmManager.PREFERENCE_PL5_KEY,        isChecked);
			break;
		case TWENTYFIVE_TOGGLEBUTTON_ID:
			lotnoAlarmManager.setLotnoSetting(LotnoAlarmManager.PREFERENCE_TWENTYFIVE_KEY, isChecked);
		}
	}

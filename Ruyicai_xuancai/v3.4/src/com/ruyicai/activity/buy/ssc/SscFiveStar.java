...
public class SscFiveStar extends ZixuanAndJiXuan  {
	...
	public void onCheckAction(int checkedId){
		...
		case 0:
			...
			areaNums[0] = new AreaNum(10,10, 11, BallResId, 0, 0,Color.RED, wantitle);
			areaNums[1] = new AreaNum(10,10, 11, BallResId, 0, 0,Color.RED, qiantitle);
			areaNums[2] = new AreaNum(10,10, 11, BallResId, 0, 0,Color.RED, baititle);
			areaNums[3] = new AreaNum(10,10, 11, BallResId, 0, 0,Color.RED, shititle);
			areaNums[4] = new AreaNum(10,10, 11, BallResId, 0, 0,Color.RED, getitle);

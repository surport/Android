...
//		thirdLinear.setVisibility(LinearLayout.VISIBLE);
	...
	public AreaNum[] initArea() {
        ...
        areaNums[0] = new AreaNum(10,10,10, ballResId, 0, 0,Color.RED,firstTitle);
        areaNums[1] = new AreaNum(10, 10, 10, ballResId, 0, 0,Color.RED,secondTitle);
        areaNums[2] = new AreaNum(10, 10, 10, ballResId, 0, 0,Color.RED,thirdTitle);
        areaNums[3] = new AreaNum(10, 10, 10, ballResId, 0, 0,Color.RED,fourthTitle);
        areaNums[4] = new AreaNum(10, 10, 10, ballResId, 0, 0,Color.RED,fifthTitle);
        areaNums[5] = new AreaNum(10, 10, 10, ballResId, 0, 0,Color.RED,sixthTitle);
        areaNums[6] = new AreaNum(10, 10, 10, ballResId, 0, 0,Color.RED,seventhTitle);
        return areaNums;
	}

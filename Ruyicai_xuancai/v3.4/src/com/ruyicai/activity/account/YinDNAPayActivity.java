...
public class YinDNAPayActivity extends Activity  implements HandlerMsg{
	...
	/**
 	...
 	public void  checkDNA() {
 		...
 		RWSharedPreferences pre = new RWSharedPreferences(YinDNAPayActivity.this, "addInfo");
 		...
 		if(sessionId==null||sessionId.equals("")){
 				Intent intentSession = new Intent(YinDNAPayActivity.this,UserLogin.class);
...
//	private Dialog RechargeType=null;
    ...
    protected void createBankCardPhoneDialog(){
	  ...
	  textContent.setText(initTextViewContent());
...
//    	final View bank_card_phone_view = factory.inflate(R.layout.account_bank_card_phone_dialog, null);
		...
		bank_card_phone_phone_num.setText(phonenum);
 		...
 		YinDNAtext_content.setText(initTextViewContent());
 ...
 // 银行卡语音充值(未绑定)DNA
    ...
    /**
 	...
 	private void beginRegisterBankPhoneCard(View vi) {
 		...
 		RWSharedPreferences shellRW = new RWSharedPreferences(YinDNAPayActivity.this, "addInfo");
	...
	private static JSONObject getJSONByLotno(){
		JSONObject  jsonObjectByLotno =  RechargeDescribeInterface.getInstance().rechargeDescribe("dnaChargeDescription");

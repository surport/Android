...
//		Log.e(tag, msg);
	 ...
	 * 
	 */
	public static void createStar(LinearLayout recordLayout, String crown, String cup, String diamond, String star,
	...
	private static void initStar(LinearLayout recordLayout, Context context, int starNum) {
		initIcon(recordLayout, context, starNum, 3);
	}

	private static void initDiamon(LinearLayout recordLayout, Context context, int diamondNum) {
		initIcon(recordLayout, context, diamondNum, 2);
	}

	private static void initCup(LinearLayout recordLayout, Context context, int cupNum) {
		initIcon(recordLayout, context, cupNum, 1);
	}

	private static void initCrown(LinearLayout recordLayout, Context context, int crownNum) {
		initIcon(recordLayout, context, crownNum, 0);
	}

	private static void initIcon(LinearLayout recordLayout, Context context, int iconNum, int index) {
	...
	public static void setEditOnclick(final EditText mTextBeishu, final int minInt,final int maxInt, final Handler handler) {
		mTextBeishu.addTextChangedListener(new TextWatcher() {

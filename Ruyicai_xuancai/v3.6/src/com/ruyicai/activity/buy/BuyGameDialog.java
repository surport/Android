...
public class BuyGameDialog {
	...
	public void initDialogView() {
		Button cancel = (Button) view.findViewById(R.id.buy_group_game_btn_cancel);
		...
		TextView title = (TextView) view.findViewById(R.id.buy_group_game_title);
		TextView content = (TextView) view.findViewById(R.id.buy_group_game_content);

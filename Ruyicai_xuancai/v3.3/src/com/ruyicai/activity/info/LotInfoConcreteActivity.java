...
public class LotInfoConcreteActivity extends Activity implements OnSeekBarChangeListener ,HandlerMsg{
    ...
    private String titletype [] ={"彩民趣闻","专家推荐","足彩天地","玄彩活动"};
  ...
  protected void onCreate(Bundle savedInstanceState) {
	...
	public void init() {
		...
		wangyi.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
		StatusDemo.publishStatusOneClick(LotInfoConcreteActivity.this, renren);
			}
		});
...
//				is_sharetosinaweibo.setBackgroundResource(R.drawable.on);
	...
	public void initTextView(){
		...
		Constants.shareContent="#玄彩# @玄彩"+title+"详情："+url;

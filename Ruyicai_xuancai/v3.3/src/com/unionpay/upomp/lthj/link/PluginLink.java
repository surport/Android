...
public class PluginLink {          
	...
	/*
	public static final int getDrawableupomp_lthj_titlebar_bg_nor(){
		return R.drawable.upomp_lthj_titlebar_bg_nor;
	}
	public static final int getDrawableupomp_lthj_money_query_head(){
		return R.drawable.upomp_lthj_money_query_head;
	}
	public static final int getDrawableupomp_lthj_money_query_body(){
		return R.drawable.upomp_lthj_money_query_body;
	}
	public static final int getDrawableupomp_lthj_money_query_bottom(){
		return R.drawable.upomp_lthj_money_query_bottom;
	}
	public static final int getDrawableupomp_lthj_checkword(){
		return R.drawable.upomp_lthj_checkword;
	}
	public static final int getDrawableupomp_lthj_grouplist_title_bg(){
		return R.drawable.upomp_lthj_grouplist_title_bg;
	}
	public static final int getDrawableupomp_lthj_grouplist_title_bg_sel(){
		return R.drawable.upomp_lthj_grouplist_title_bg_sel;
	}
	public static final int getDrawableupomp_lthj_home_btn_bg(){
		return R.drawable.upomp_lthj_home_btn_bg;
	}
	public static final int getDrawableupomp_lthj_home_btn_bg_d(){
		return R.drawable.upomp_lthj_home_btn_bg_d;
	}
	public static final int getDrawableupomp_lthj_home_btn_bg_n(){
		return R.drawable.upomp_lthj_home_btn_bg_n;
	}
	public static final int getDrawableupomp_lthj_home_btn_bg_s(){
		return R.drawable.upomp_lthj_home_btn_bg_s;
	}
	public static final int getDrawableupomp_lthj_icon(){
		return R.drawable.upomp_lthj_icon;
	}
	public static final int getDrawableupomp_lthj_icon_0(){
		return R.drawable.upomp_lthj_icon_0;
	}
	public static final int getDrawableupomp_lthj_icon_1(){
		return R.drawable.upomp_lthj_icon_1;
	}
	public static final int getDrawableupomp_lthj_icon_2(){
		return R.drawable.upomp_lthj_icon_2;
	}
	public static final int getDrawableupomp_lthj_icon_3(){
		return R.drawable.upomp_lthj_icon_3;
	}*/
	/**************************************id***************************************/
...
/*	public static final int getStyleupomp_lthj_tablerow2(){
		return R.style.upomp_lthj_tablerow2;
	}*/
	/****************************raw*************************************/

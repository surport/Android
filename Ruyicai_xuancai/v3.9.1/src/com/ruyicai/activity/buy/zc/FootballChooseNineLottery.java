	...
	Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case 0:
				...
				Toast.makeText(getBaseContext(), "网络异常！", Toast.LENGTH_SHORT)
						.show();
				break;
			case 1:
				progressdialog.dismiss();
			...
			case 6:
				...
				FootballContantDialog
						.alertIssueNOFQueue(FootballChooseNineLottery.this);
				break;
			case 7:
				progressdialog.dismiss();
			...
			case 15:
				...
				Intent intentSession = new Intent(
						FootballChooseNineLottery.this, UserLogin.class);
...
//				mSeekBarBeishu, true);
	...
	private class ListViewAdapterChooseNine extends BaseAdapter {
		...
		public ListViewAdapterChooseNine(Context context,
				List<Map<String, Object>> list) {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			if (convertView == null) {
				convertView = mInflater.inflate(
						R.layout.buy_zc_sfc_main_listview_item, parent, false);
			...
			int START_ID = RENXJ_START_ID + position * 3;
			final int indexPosition = position;
			if (isaWait) {
				final BallTable renxuanjRow = makeBallTable(
						(LinearLayout) convertView, R.id.shengfucai_ball, aResIdForWait,
						...
						public void onClick(View v) {
							...
							if (isMultipleBets()) {
								...
								if (ball.getiShowString().equals("胆")) {
									...
									} else if (getDanNums() == 8 && ball.getShowId() == 1) {
										ball.changeBallColor();
									}
								} else {
									// 如果点击不是胆球，则小球变色
...
//	}
	...
	public void beginTouZhu() {
		...
		if (sessionIdStr == null || sessionIdStr.equals("")) {
			...
			if (iZhuShu == 0) {
				Toast.makeText(FootballChooseNineLottery.this, "请至少选择一注！",
						Toast.LENGTH_SHORT).show();
	...
	void toorderdetail() {
		...
		app.setPojo(betPojo);
		Intent intent = new Intent(FootballChooseNineLottery.this,
...
//	}
	...
	public void errorCode_0000() {
		...
		PublicMethod.showDialog(FootballChooseNineLottery.this, lotnoString
				+ codeStr);
	}
	...
	private void showBatchcodesDialog(/*String[] batchCodes*/) {
		AlertDialog batchCodedialog = new AlertDialog.Builder(
				FootballChooseNineLottery.this).setTitle("任选九预售期")

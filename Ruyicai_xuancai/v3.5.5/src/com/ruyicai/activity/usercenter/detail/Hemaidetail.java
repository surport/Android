...
public class Hemaidetail extends Activity implements HandlerMsg {
	private TextView name, describe, atm, id, renAtm, baoAtm, progress, state,
			...
			safeProgress, safeText, minText, minText1,lotnotext,beishutext,batchcodetext ,faqirengou,wincode,winamt;
...
//		Toast.makeText(Hemaidetail.this, "网易分享", Toast.LENGTH_SHORT).show();	
				StatusDemo st=new StatusDemo();
             	st.publishStatusOneClick(Hemaidetail.this, renren);
			}
		});
		xinlang.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
//				Toast.makeText(Hemaidetail.this, "新浪分享", Toast.LENGTH_SHORT).show();		
				oauthOrShare();
...
//					anim.setFillAfter(true);
	...
	public void isLogin() {
		...
		if (sessionid == null || sessionid.equals("")) {
			Intent intentSession = new Intent(Hemaidetail.this,
					UserLogin.class);
    ...
    private void getMore(){
		...
		if (pageindex < allpage) {
			...
			pageindex = allpage - 1;
			Toast.makeText(Hemaidetail.this, "已至尾页",
					Toast.LENGTH_SHORT).show();
		}
    }
	/**

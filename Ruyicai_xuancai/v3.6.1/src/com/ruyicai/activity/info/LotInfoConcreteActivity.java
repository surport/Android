...
public class LotInfoConcreteActivity extends Activity implements OnSeekBarChangeListener ,HandlerMsg{
    ...
    private String titletype [] ={"彩民趣闻","专家推荐","足彩天地","玄彩公告"};
...
//	renren=new Renren(this);
	shellRW = new RWSharedPreferences(LotInfoConcreteActivity.this, "addInfo");
...
//					anim.setFillAfter(true);
			        ...
			        anim.setAnimationListener(new AnimationListener() {
						...
						public void onAnimationEnd(Animation animation) {
						   ...
						   lp.setMargins(PublicMethod.getPxInt(265, LotInfoConcreteActivity.this), 0, 0, 0);
...
//					anim.setFillAfter(true);
	...
	public void tenoauth(){
		...
		if(tencent_token.equals("")&&tencent_access_token_secret.equals("")){
		   ...
		   Intent  intent = new Intent(LotInfoConcreteActivity.this, OAuthV1AuthorizeWebView.class);//创建Intent，使用WebView让用户授权
		   ...
		   startActivityForResult(intent,1);	
			...
			Intent intent=new Intent(LotInfoConcreteActivity.this, TencentShareActivity.class);

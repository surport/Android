...
public class NoticeZCActivity extends BuyActivityGroup{
	int lotnoZC[] = {NoticeActivityGroup.ID_SUB_SFC_LISTVIEW,NoticeActivityGroup.ID_SUB_RXJ_LISTVIEW,NoticeActivityGroup.ID_SUB_JQC_LISTVIEW,NoticeActivityGroup.ID_SUB_LCB_LISTVIEW};
	@Override
	public void onCreate(Bundle savedInstanceState) {
		...
		Class[] allId8 = { NoticeInfoActivity.class,NoticeInfoActivity.class,NoticeInfoActivity.class,NoticeInfoActivity.class };

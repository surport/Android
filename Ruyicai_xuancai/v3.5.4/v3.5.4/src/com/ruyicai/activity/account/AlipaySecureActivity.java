...
//				RechargeType.dismiss();
	...
	private static JSONObject getJSONByLotno(){
		JSONObject  jsonObjectByLotno =  RechargeDescribeInterface.getInstance().rechargeDescribe("zfbChargeDescription");
	...
	public void errorCode_0000() {
		// TODO Auto-generated method stub
		if(isWebView){
			Intent intent = new Intent(AlipaySecureActivity.this,AccountDialog.class);

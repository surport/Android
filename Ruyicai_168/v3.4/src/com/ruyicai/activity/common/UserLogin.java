...
public class UserLogin extends Activity implements TextWatcher {
   ...
   public View getView(){
	...
	private void turnToLogin() {
		...
		LinearLayout forget_password = (LinearLayout) findViewById(R.id.findoutpassword);
		...
		// 点击注册按钮时，跳转到注册页面
		LinearLayout register = (LinearLayout) findViewById(R.id.doregister);
		...
		LinearLayout phoneofkefu = (LinearLayout) findViewById(R.id.phoneofkefu);

...
public class ZixuanZhuihao extends Activity implements HandlerMsg,
	...
	private void init() {
		...
		if (type.equals("hight")) {
			...
			issueText.setText("第" + PublicMethod.toIssue(betAndGift.getLotno())
					+ "期");
		}
			...
			edit.addTextChangedListener(new TextWatcher() {
				...
				public void afterTextChanged(Editable s) {
				    ...
				    edit.setText("1");
						...
						text3.setText(addview.getAllAmt()* Integer.valueOf(edit.getText().toString())+ "元");
	...
	public void getTouzhuAlert() {
		...
		if(state==0||state==1){
			jine.setText("金额："+iProgressQishu * addview.getAllAmt() * iProgressBeishu+ "元");
			}else if(state==2){
			jine.setText("金额："+getSubstringforamt()+ "元");
			}
		}

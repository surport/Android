...
public class ZixuanZhuihao extends Activity implements HandlerMsg,OnSeekBarChangeListener{
	...
	private void init(){
		...
		codeInfo.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				ZixuanActivity.addView.createCodeInfoDialog(ZixuanZhuihao.this);
			...
			edit.addTextChangedListener(new TextWatcher() {
				...
				public void afterTextChanged(Editable s) {
					...
					if(edit.getText().toString().equals("")){
						...
						text3.setText(ZixuanActivity.addView.getAllAmt()
...
//		zhushu.setText(ZixuanActivity.addView.getAllZhu() + "注     " );
		zhushu.setText(ZixuanActivity.addView.getAllZhu() + "注     " );
		if(state==0||state==1){
			jine.setText("金额："+iProgressQishu * ZixuanActivity.addView.getAllAmt() * iProgressBeishu+ "元");
			}else if(state==2){

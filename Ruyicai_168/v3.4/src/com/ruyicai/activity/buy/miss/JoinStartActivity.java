 ...
 *
 */
public class JoinStartActivity extends Activity implements HandlerMsg,OnCheckedChangeListener,OnSeekBarChangeListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		getInfo();
		allAtm = iProgressQishu * ZixuanActivity.addView.getAllAmt() * iProgressBeishu;		
		init();
		initRadioGroup();
	}
	public void init(){
		...
		if(type.equals("zc")){
			...
			codeInfo.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					ZixuanActivity.addView.createCodeInfoDialog(JoinStartActivity.this);
		...
		//赋值
		onEditTextClik();
		renText.setText("占总额" +  progress(isNull(buyEdit.getText().toString()),""+allAtm) + "%");// 总金额
		baoText.setText("占总额" +  progress(isNull(safeEdit.getText().toString()),""+allAtm) + "%");// 总金额
	}
...
//				+ "元"; 
	...
	public void onEditTextClik(){
		buyEdit.addTextChangedListener(new TextWatcher() {
			...
			public void afterTextChanged(Editable s) {
				...
				renText.setText("占总额" +  progress(isNull(amount),""+allAtm) + "%");// 总金额
				setEditText();
			}
		...
		safeEdit.addTextChangedListener(new TextWatcher() {
			...
			public void afterTextChanged(Editable s) {
				...
				baoText.setText("占总额" +  progress(isNull(amount),""+allAtm) + "%");// 总金额
				setEditText();
			}
			public void beforeTextChanged(CharSequence s, int start, int count,int after) {
   ...
   /**
	...
	private void initZhuiJia() {
		...
		zhuijiatouzhu.setOnCheckedChangeListener(new android.widget.CompoundButton.OnCheckedChangeListener() {			

 ...
 *
 */
public class JoinStartActivityjc extends Activity implements HandlerMsg,OnCheckedChangeListener{
	...
	public void init(){
		...
		titleText.setText("发起合买-"+PublicMethod.toLotno(betAndGift.getLotno()));
    ...
    public void showfenxdialog(){
        ...
        share.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				// TODO Auto-generated method stub
				dialog.cancel();
				Intent intent =new Intent(JoinStartActivityjc.this,JoinStarShare.class);

...
public class Dlc extends ZixuanAndJiXuan {
	private String type[] = {"R2","R3","R4","R5","R6","R7","R8","R1","Q2","Q3","Z2","Z3"};//类型
	private int nums[] = {2,3,4,5,6,7,8,1,2,3,2,3};//单式机选个数
	private int numsdantuo[]={};
	private int maxs[] = {3,4,7,10,8,9,8,6,11,11,8,9};//选区最大小球数
	private String titles[] = {"任选二","任选三","任选四","任选五","任选六","任选七","任选八","选前一","选前二","选前三","选前二组选","选前三组选"};//标题组
	...
	public AreaNum[] initArea() {
		...
		if(state.equals("Q2")){
			...
			areaNums[0] = new AreaNum(11,10, 11, BallResId, 0, 1,Color.RED, wantitle);
			areaNums[1] = new AreaNum(11,10, 11, BallResId, 0, 1,Color.RED, qiantitle);
		}else if(state.equals("Q3")){
			areaNums = new AreaNum[3];
			areaNums[0] = new AreaNum(11,10, 11, BallResId, 0, 1,Color.RED, wantitle);
			areaNums[1] = new AreaNum(11,10, 11, BallResId, 0, 1,Color.RED, qiantitle);
			areaNums[2] = new AreaNum(11,10, 11, BallResId, 0, 1,Color.RED, baititle);
		}else{
			areaNums = new AreaNum[1];
	        String title = "请选择投注号码" ;
			areaNums[0] = new AreaNum(11,10, 11, BallResId, 0, 1,Color.RED, title);
		}
       return areaNums;
	}

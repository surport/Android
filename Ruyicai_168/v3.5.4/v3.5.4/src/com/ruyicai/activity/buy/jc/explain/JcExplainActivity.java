...
import com.ruyicai.activity.buy.jc.score.JcScoreListActivity;
...
public class JcExplainActivity extends BuyActivityGroup{
    private String titleStr = "球队数据分析";
	private String[] titles ={"分析","欧指","亚盘"};
	private String[] topTitles ={titleStr,titleStr,titleStr,titleStr};
	private Class[] allId ={ExplainListActivity.class,EuropeActivtiy.class,AsiaActivity.class};
	 ...
	 * 获取玩法介绍联网
	 */
	public void getExplainNet(final String event){
		...
		Thread t = new Thread(new Runnable() {
			...
			@Override
			public void run() {
				str = ExplainInterface.getExplain(event);
				try {

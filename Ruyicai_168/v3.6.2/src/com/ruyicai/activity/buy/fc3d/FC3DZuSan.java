...
public class FC3DZuSan extends ZixuanActivity implements OnCheckedChangeListener{
	...
	private void create_FC3D_HEZHI_ZU3() {
		...
		getMissNet(new Fc3dMissJson(),MissConstant.FC3D_Z36HZ,MissConstant.FC3D_Z36HZ);
	}
	/**
	 * 初始化滑动
	 */
	...
	public AreaNum[] initArea() {
		...
		case PublicConst.BUY_FC3D_ZU3_DAN:
			...
			areaNums[0] = new AreaNum(10,10,1, 1, ballResId, 0, 0, Color.RED, baiTitle,false,true,true);
			areaNums[1] = new AreaNum(10,10,1, 1, ballResId, 0, 0, Color.RED, shiTitle,false,true,true);
	        return areaNums;
		case PublicConst.BUY_FC3D_ZU3_FU:
			areaNums = new AreaNum[1];
			String title2 = getResources().getString(R.string.fc3d_text_hezhi_title).toString();
			areaNums[0] = new AreaNum(10,10,2, 10, ballResId, 0, 0, Color.RED, title2,false,true);
	        return areaNums;
		case PublicConst.BUY_FC3D_HEZHI_ZU3:
			areaNums = new AreaNum[1];
	        String title3 = getResources().getString(R.string.fc3d_text_hezhi_title).toString();
	        areaNums[0] = new AreaNum(26,8,1, 1, ballResId, 0, 1,Color.RED,title3,false,true);
	        return areaNums;
		}
		return areaNums;
	}
   ...
   */
	...
	public void isBallTable(int iBallId){
		...
		case PublicConst.BUY_FC3D_ZU3_FU:
			 ...
			 areaNums1[0].table.changeBallState(areaNums1[0].chosenBallSum, iBallId);
			break;
		case PublicConst.BUY_FC3D_HEZHI_ZU3:
			 areaNums[0].table.clearAllHighlights();
			 areaNums[0].table.changeBallState(areaNums[0].chosenBallSum, iBallId);

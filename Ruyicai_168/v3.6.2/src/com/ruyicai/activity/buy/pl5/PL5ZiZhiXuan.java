...
public class PL5ZiZhiXuan  extends ZixuanActivity {
	...
	public AreaNum[] initArea() {
        ...
        areaNums[0] = new AreaNum(10, 10, 1, 10, ballResId, 0, 0,Color.RED,wanTitle,false,true);
        areaNums[1] = new AreaNum(10, 10, 1, 10, ballResId, 0, 0,Color.RED,qianTitle,false,true);
        areaNums[2] = new AreaNum(10, 10, 1, 10, ballResId, 0, 0,Color.RED,baiTitle,false,true);
        areaNums[3] = new AreaNum(10, 10, 1, 10, ballResId, 0, 0,Color.RED,shiTitle,false,true);
        areaNums[4] = new AreaNum(10, 10, 1, 10, ballResId, 0, 0,Color.RED,geTitle,false,true);
        return areaNums;
	}

...
public class JcScoreInfoActivity extends Activity{
	private int[] imageViews = { R.drawable.kind_1,R.drawable.kind_7,R.drawable.kind_8,R.drawable.kind_3,R.drawable.kind_2
			                     ,R.drawable.kind_9,R.drawable.kind_10,R.drawable.kind_11,R.drawable.kind_4,R.drawable.kind_5};
     ...
     * 加载每一行的单选按钮
     * @param layoutMain
     * @param lineNum 每一行的个数 
     */
	private void addLine(LinearLayout layoutMain, int lineNum,int[] imageViews,String[] imgTitle) {
	...
	private void lineView(LinearLayout layoutMain,int lineNum, int[] imageViews, String[] imgTitle,int line,int linelast) {

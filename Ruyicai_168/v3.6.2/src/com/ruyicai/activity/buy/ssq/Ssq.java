...
public class Ssq extends BuyActivityGroup {
	...
	public void addSimulateSelectNumber(View view) {
		LinearLayout simulaterLayout = (LinearLayout) view.findViewById(R.id.buy_group_one_layout5);
		...
		simulaterLayout.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(Ssq.this,SimulateSelectNumberActivity.class);

...
//		thirdLinear.setVisibility(LinearLayout.VISIBLE);
	...
	public AreaNum[] initArea() {
        ...
        areaNums[0] = new AreaNum(10, 10, 1, 10, ballResId, 0, 0,Color.RED,firstTitle,false,true);
        areaNums[1] = new AreaNum(10, 10, 1, 10, ballResId, 0, 0,Color.RED,secondTitle,false,true);
        areaNums[2] = new AreaNum(10, 10, 1, 10, ballResId, 0, 0,Color.RED,thirdTitle,false,true);
        areaNums[3] = new AreaNum(10, 10, 1, 10, ballResId, 0, 0,Color.RED,fourthTitle,false,true);
        areaNums[4] = new AreaNum(10, 10, 1, 10, ballResId, 0, 0,Color.RED,fifthTitle,false,true);
        areaNums[5] = new AreaNum(10, 10, 1, 10, ballResId, 0, 0,Color.RED,sixthTitle,false,true);
        areaNums[6] = new AreaNum(10, 10, 1, 10, ballResId, 0, 0,Color.RED,seventhTitle,false,true);
        return areaNums;
	}

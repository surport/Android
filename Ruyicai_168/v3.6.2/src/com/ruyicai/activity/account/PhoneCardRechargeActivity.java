    ...
    protected void createPhoneRechargeCardDialog(){
		...
		ok.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				// TODO Auto-generated method stub
				RWSharedPreferences pre = new RWSharedPreferences(PhoneCardRechargeActivity.this, "addInfo");
				String sessionIdStr = pre.getStringValue(ShellRWConstants.SESSIONID);
				if (sessionIdStr!=null&&sessionIdStr.equals("")) {
					Intent intentSession = new Intent(PhoneCardRechargeActivity.this,UserLogin.class);
					startActivity(intentSession);}
				else{
					if( phoneCardType == null){
						Toast.makeText(PhoneCardRechargeActivity.this, "请选择运营商", Toast.LENGTH_SHORT).show();
					}else if(phoneCardValue == null){
						Toast.makeText(PhoneCardRechargeActivity.this, "请选择充值金额", Toast.LENGTH_SHORT).show();
					}else{
...
//    	        return RechargeType;
    ...
    private static JSONObject getJSONByLotno(){
		JSONObject  jsonObjectByLotno =  RechargeDescribeInterface.getInstance().rechargeDescribe("phoneCardChargeDescription");
	...
	public void errorCode_0000() {
		// TODO Auto-generated method stub
		Toast.makeText(PhoneCardRechargeActivity.this, message, Toast.LENGTH_SHORT).show();
		PhoneCardRechargeActivity.this.finish();
	}
	@Override

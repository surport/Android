...
//    	String alertStr = getString(R.string.forget_password_hint).toString();
//    	String alertPhone = getString(R.string.phone_kefu).toString();
//    	builder.append(alertStr);
//    	builder.setSpan(new URLSpan("tel:"+alertPhone ),28, (28+alertPhone.length()),Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);

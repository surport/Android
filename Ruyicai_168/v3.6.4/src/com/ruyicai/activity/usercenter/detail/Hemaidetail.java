...
public class Hemaidetail extends Activity implements HandlerMsg {
	...
	public void init() {
		...
		PublicMethod.createStar(starLayout, detatil.getCrown(),
				detatil.getGrayCrown(), detatil.getCup(), detatil.getGrayCup(),
				detatil.getDiamond(), detatil.getGrayDiamond(),
				detatil.getStar(), detatil.getGrayStarNum(), Hemaidetail.this,
				0);
	...
	public JoinDetatil getValue() {
		...
		try {
			...
			Constants.shareContent = "Hi，我刚使用了如意彩手机客户端买彩票，很方便呢！"
					+ "你也试试吧，彩票随身投，大奖时时有！中奖了记的要请客啊！下载地址:" + detatil.getUrl();
...
//		content.setText(Html.fromHtml("方案内容：<br>" + detatil.getContentHtml()));
		...
		PublicMethod.createStar(starLayout, detatil.getCrown(),
				detatil.getGrayCrown(), detatil.getCup(), detatil.getGrayCup(),
				detatil.getDiamond(), detatil.getGrayDiamond(),
				detatil.getStarNum(), detatil.getGrayStarNum(),
				Hemaidetail.this, 0);
	...
	class JoinDetatil {
		...
		public void setLotnoJc(String lotnoJc) {
			this.lotnoJc = lotnoJc;
		}
		...
		public void setBuyamtbystarter(String buyamtbystarter) {
			this.buyamtbystarter = Integer.toString(Integer
					.parseInt(buyamtbystarter) / 100);

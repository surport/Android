...
public class NewUserCenter extends Activity implements MyDialogListener {
	...
	private String notReadLetterCount="";
	...
	final Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case 11:
				...
				feedListIntent.putExtra("notReadLetterCount", notReadLetterCount);
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				try {
					...
					notReadLetterCount=json.getString("notReadLetterCount");
					msg.what = 8;
					handler.sendMessage(msg);
				} catch (JSONException e) {
					msg.what = 9;
	...
	public class UerCenterAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				...
				if(title.equals("在线留言")&&!notReadLetterCount.equals("")&&!notReadLetterCount.equals("0")){
			    holder.log.setVisibility(View.VISIBLE);
			    holder.log.setText(notReadLetterCount);
				}
	...
	protected List<Map<String, Object>> getListForusersetAdapter() {
		String[] titles = { "密码修改", "身份证绑定", "手机号绑定", "在线留言" };
		String[] titles1 = { "身份证绑定", "手机号绑定", "在线留言" };

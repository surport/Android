...
public class ScroesRules {
	...
	ScroesRules(Context context){
		...
		progressDialog = UserCenterDialog.onCreateDialog(scroesContext, "loading........");
		progressDialog.show();
		initScoreDialog();
		MobclickAgent.onEvent(scroesContext,"shuoming" ); //BY贺思明 在用户中心主页点击上面的积分后面的“说明”。
	}
	private void initScoreDialog() {
		// TODO Auto-generated method stub
		LayoutInflater inflater = (LayoutInflater) scroesContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
	    View   view = inflater.inflate(R.layout.userscroe_show, null);
		Handler handler = new Handler();
	    final TextView scoresrules = (TextView)view.findViewById(R.id.userscore_webview);

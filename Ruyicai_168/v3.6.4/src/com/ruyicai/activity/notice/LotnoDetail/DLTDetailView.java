...
public class DLTDetailView extends LotnoDetailView{
	...
	LinearLayout linear8,linear9,linear10,linear11,linear12,linear13,linear14,linear15,linear16;
	Button tobet;
	JSONObject json;
	String wincode;
	
	
	public DLTDetailView(Activity context, String lotno, String batchcode,ProgressDialog progress,Handler handler,boolean isDialog) {
	...
	void initLotnoDetailViewWidget() {
		...
		prizename10 = (TextView)view.findViewById(R.id.prizedetail_prizename10);
		prizename11 = (TextView)view.findViewById(R.id.prizedetail_prizename11);
		prizename12 = (TextView)view.findViewById(R.id.prizedetail_prizename12);
		prizename13 = (TextView)view.findViewById(R.id.prizedetail_prizename13);
		prizename14 = (TextView)view.findViewById(R.id.prizedetail_prizename14);
		prizename15 = (TextView)view.findViewById(R.id.prizedetail_prizename15);
		prizename16 = (TextView)view.findViewById(R.id.prizedetail_prizename16);
		...
		prizemoney8 =(TextView)view.findViewById(R.id.prizedetail_prizemoney8);
		prizemoney9 =(TextView)view.findViewById(R.id.prizedetail_prizemoney9);
		prizemoney10 =(TextView)view.findViewById(R.id.prizedetail_prizemoney10);
		prizemoney11 =(TextView)view.findViewById(R.id.prizedetail_prizemoney11); 
		prizemoney12 =(TextView)view.findViewById(R.id.prizedetail_prizemoney12);
		prizemoney13 =(TextView)view.findViewById(R.id.prizedetail_prizemoney13);
		prizemoney14 =(TextView)view.findViewById(R.id.prizedetail_prizemoney14);
		prizemoney15 =(TextView)view.findViewById(R.id.prizedetail_prizemoney15);
		prizemoney16 =(TextView)view.findViewById(R.id.prizedetail_prizemoney16);
		...
		linear10 = (LinearLayout)view.findViewById(R.id.notice_detail_linear10);
		linear11 = (LinearLayout)view.findViewById(R.id.notice_detail_linear11);
		linear12 = (LinearLayout)view.findViewById(R.id.notice_detail_linear12);
		linear13 = (LinearLayout)view.findViewById(R.id.notice_detail_linear13);
		linear14 = (LinearLayout)view.findViewById(R.id.notice_detail_linear14);
		linear15 = (LinearLayout)view.findViewById(R.id.notice_detail_linear15);
		linear16 = (LinearLayout)view.findViewById(R.id.notice_detail_linear16);
	...
	public void initLotonoView(JSONObject json) throws JSONException{
		...
		PrizeBallLinearLayout ssqBallLinear = new PrizeBallLinearLayout(context, ballLinear, Constants.DLTLABEL, prizeNum);
		...
		prizepoolmoney.setText(context.getString(R.string.prizedetail_theprizepoolamt)+PublicMethod.toIntYuan(json.getString("prizePoolTotalAmount"))+context.getString(R.string.game_card_yuan));
		...
		prizemoney2.setText(PublicMethod.toIntYuan(json.getString("onePrizeZJAmt")));
		prizemoney3.setText(PublicMethod.toIntYuan(json.getString("twoPrizeAmt")));
		prizemoney4.setText(PublicMethod.toIntYuan(json.getString("twoPrizeZJAmt")));
		prizemoney5.setText(PublicMethod.toIntYuan(json.getString("threePrizeAmt")));
		prizemoney6.setText(PublicMethod.toIntYuan(json.getString("threePrizeZJAmt")));
		prizemoney7.setText(PublicMethod.toIntYuan(json.getString("fourPrizeAmt")));
		prizemoney8.setText(PublicMethod.toIntYuan(json.getString("fourPrizeZJAmt")));
		prizemoney9.setText(PublicMethod.toIntYuan(json.getString("fivePrizeAmt")));
		prizemoney10.setText(PublicMethod.toIntYuan(json.getString("fivePrizeZJAmt")));
		prizemoney11.setText(PublicMethod.toIntYuan(json.getString("sixPrizeAmt")));
		prizemoney12.setText(PublicMethod.toIntYuan(json.getString("sixPrizeZJAmt")));
		prizemoney13.setText(PublicMethod.toIntYuan(json.getString("sevenPrizeAmt")));
		prizemoney14.setText(PublicMethod.toIntYuan(json.getString("sevenPrizeZJAmt")));
		prizemoney15.setText(PublicMethod.toIntYuan(json.getString("eightPrizeAmt")));
		prizemoney16.setText(PublicMethod.toIntYuan(json.getString("twelveSelect2PrizeAmt")));
	...
	public String getShareString() {
		...
		try {
			str.append("#如意彩客户端#，").append("大乐透第"+json.getString("batchCode")+"期,");
			str.append(context.getString(R.string.prizedetail_opentime)+json.getString("openTime")+",");
			str.append("开奖号码:"+wincode+",");
			str.append(context.getString(R.string.prizedetail_thebatchcodeamt)+PublicMethod.toIntYuan(json.getString("sellTotalAmount"))+context.getString(R.string.game_card_yuan)+",");
			str.append("奖池奖金"+PublicMethod.toIntYuan(json.getString("prizePoolTotalAmount"))+context.getString(R.string.game_card_yuan)+",");

...
public class NoticeMainActivity extends Activity  {
	...
	private static final Integer[] mIcon = { R.drawable.join_ssq,R.drawable.join_fc3d, R.drawable.join_qlc,
											 ...
											 R.drawable.join_11ydj, R.drawable.join_gd11x5,R.drawable.join_sfc,R.drawable.join_rx9,
											 R.drawable.join_6cb,R.drawable.join_jqc,R.drawable.join_jcz,R.drawable.join_jcl,R.drawable.notice_ten}; // zlm 8.9 添加排列三、超级大乐透图标
	private static final String[] titles = {"双色球","福彩3D","七乐彩","大乐透","排列三","排列五","七星彩","22选5","时时彩","江西11选5","11运夺金","广东11选5","足彩胜负","任选九","六场半","进球彩","竞彩足球","竞彩篮球","广东快乐十分"};
	// 新加获取时时彩信息
	public static final String iGameName[] = {"ssq", "fc3d", "qlc","cjdlt","pl3","pl5","qxc", "22-5","ssc", "11-5", "11-ydj","gd-11-5","sfc", "rxj", "lcb", "jqc","jcz","jcl","gd-10"}; // 8.9
	...
	private void showMainListView() {
		...
		list = NoticeDataProvider.getListForMainListViewSimpleAdapter(NoticeMainActivity.this);//获取开奖信息数据
		...
		OnItemClickListener clickListener = new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,int position, long id) {
				...
				TextView nameText = (TextView) view.findViewById(R.id.notice_prizes_main_title);
				...
				// 点击双色球跳转到双色球子列表中
				if (name.equals("双色球")) {
					MobclickAgent.onEvent(NoticeMainActivity.this,"kaijiangshuangseqiu" ); //BY贺思明 点击“双色球”图标及开奖号区域。
				...
				// 点击时时彩跳转到胜负彩子列表中
				if (name.equals("足彩胜负")) {
					Intent intent = new Intent(NoticeMainActivity.this, NoticeZCActivity.class); 
					startActivity(intent);
				}
//				// 点击时时彩跳转到任选九彩子列表中
//				if (name.equals("任选九")) {
...
//				}
	...
	public  class MainEfficientAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			RWSharedPreferences	shellRW = new RWSharedPreferences(NoticeMainActivity.this, ShellRWConstants.CAIZHONGSETTING);
			...
			holder.scoreBtn = (Button) convertView.findViewById(R.id.notice_prizes_main_btn_score);
			...
			if (iGameType.equals("ssq")) {
				...
				singleOrSmallTextView.setTypeface(Typeface.defaultFromStyle(Typeface.BOLD));
				...
				singleOrSmallTextView.setBackgroundResource(R.drawable.singleorsmall);
...
//				tvFootball.setTextColor( R.color.darkgreen);
				...
				for (i1 = 0; i1 < 8; i1++) {
					...
					if(iShowNumber == 19||iShowNumber == 20){
						...
						tempBallView = new OneBallView(convertView.getContext(),1);
						tempBallView.initBall(BALL_WIDTH-deletW, BALL_WIDTH-deletW, ""+ iShowNumber, aBlueColorResId);
						holder.numbers.addView(tempBallView);
					}
				 }

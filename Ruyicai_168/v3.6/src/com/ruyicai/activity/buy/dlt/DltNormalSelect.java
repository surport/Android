...
public class DltNormalSelect extends ZixuanActivity {
	...
	public AreaNum[] initArea() {
		...
		String redTitle = getResources().getString(R.string.front_field).toString();
        String blueTitle = getResources().getString(R.string.rear_field).toString();
        areaNums[0] = new AreaNum(35,9,5, 18, redBallResId, 0, 1,Color.RED,redTitle,true,true);
        areaNums[1] = new AreaNum(12,9,2, 12, blueBallResId, 0, 1,Color.BLUE,blueTitle,true,true);
        return areaNums;
	}

...
import com.ruyicai.activity.buy.jc.explain.JcExplainActivity;
...
//		aa.append("最小中奖金额：").append(mixValue).append("元，").append("最大中奖金额：").append(maxValue).append("元");
	    	return "" ;
	    }
	/**
	 * 获取多串过关的中奖金额的最大值和最小值
    ...
    public double getFreedomMaxPrize(int select){
    	return JCPrizePermutationandCombination.getFreedomGuoGuanMaxPrize(getOddsArraysValue(), select,isDanList,getIsDanNum());
    }

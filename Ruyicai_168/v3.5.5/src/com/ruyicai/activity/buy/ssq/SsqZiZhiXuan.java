...
//		   mGallery.setAreaWith(100);
	...
	public AreaNum[] initArea() {
        ...
        areaNums[0] = new AreaNum(33,9,6, 16, redBallResId, 0, 1,Color.RED,redTitle,true,true);
        areaNums[1] = new AreaNum(16,9,1, 16, blueBallResId, 0, 1,Color.BLUE,blueTitle,true,true);
        return areaNums;
	}

...
public class BuyActivity extends Activity implements OnClickListener {
	...
	private int[] imageViews = { R.drawable.ico_buy, R.drawable.ico_double,R.drawable.ico_super,
			...
			R.drawable.icon_jc,R.drawable.ten_icon, R.drawable.ico_eleven,R.drawable.ico_expert,R.drawable.gd_eleven,
	...
	private String[] imageTitle = { "合买大厅", "双色球", "大乐透", "福彩3D", "江西11选5","时时彩", "竞彩足球", "广东快乐十分","11运夺金","专家荐号", "广东11选5","排列三", "七乐彩","22选5","排列五","七星彩","足彩",
			 "竞彩篮球"};
	private final Class[] cla = { JoinInfoActivity.class, Ssq.class,Dlt.class,
			Fc3d.class,Dlc.class, Ssc.class,  ZqMainActivity.class,TenActivity.class,Eleven.class,ExpertActivity.class,GdEleven.class,PL3.class,
				...
				if(!lotno.equals("hmdt")&&!lotno.equals("gd-10")&&!lotno.equals("zjjh")){
					if(lotno.equals("F47104")||lotno.equals("F47102")||lotno.equals("T01001")){
						try {
							...
							}else if(isTodayOpenPrize.equals("true")&&isaddString.equals("false")){
								imgView.setImageResource(R.drawable.kaijiang);

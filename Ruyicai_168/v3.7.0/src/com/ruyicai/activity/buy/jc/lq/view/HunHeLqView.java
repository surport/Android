...
import com.ruyicai.activity.buy.jc.lq.view.SfcView.JcInfoAdapter;
import com.ruyicai.activity.buy.jc.lq.view.SfcView.JcInfoAdapter.ViewHolder;
...
public class HunHeLqView extends JcMainView{
	...
	BasketHun   basketHun;
	public HunHeLqView(Context context, BetAndGiftPojo betAndGift,Handler handler, LinearLayout layout, String type,
	...
	public void setDifferValue(JSONObject jsonItem,Info itemInfo) throws JSONException{
		...
		for(int n=0;n<sfc_lenght;n++){
			itemInfo.vStrs[n+before_lenght] = jsonItem.getString("v"+BasketSFC.bqcType[n]);
		}	
		initTitles(itemInfo);
	}
			...
			btn.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					if(info.onclikNum>0||isCheckTeam()){
						info.createDialog(BasketHun.titleStrs,false,info.getAway()+" VS "+info.getHome());
					}
					isNoDan(info,btnDan);
				}
